...
namespace FamiStudio
{
    public class FamitoneMusicFile
    {
        ...
        private int OutputHeader(bool separateSongs)
        {
            ...
            lines.Add($"\t{dw} {ll}music_data_{name}_samples-{(kernel == FamiToneKernel.FamiTone2 ? 3 : (project.SoundEngineUsesDpcmBankSwitching ? 5 : 4))}");
            ...
            for (int i = 0; i < project.Songs.Count; i++)
            {
                ...
                for (int chn = 0; chn < song.Channels.Length; ++chn)
                {
                    ...
                    lines.Add($"\t{dw} {ll}music_data_{name}_song{i}ch{chn}");
                ...
                for (int i = 0; i < project.Instruments.Count; i++)
                {
                        ...
                        instrument.IsEpsm)
                    {
                        ...
                        if (instrument.IsFds)
                        {
                            ...
                            lines.Add($"\t{dw} {ll}music_data_{name}_env{fdsWavEnvIdx}");
                            ...
                            lines.Add($"\t{dw} {ll}music_data_{name}_env{fdsModEnvIdx}");
