...
; each assembler.
;
; For SDAS, you need to specify the name of your ZEROPAGE, RAM/BSS and CODE/PRG segments as c-style macros (.define)
...
.if FAMISTUDIO_USE_NOISE_SLIDE_NOTES & ~FAMISTUDIO_USE_SLIDE_NOTES
    .msg "Noise slide notes can only be used when regular slide notes are enabled too."
    .error 1
.endif
...
.if FAMISTUDIO_USE_FAMITRACKER_DELAYED_NOTES_OR_CUTS & ~FAMISTUDIO_USE_FAMITRACKER_TEMPO
    .msg "Delayed notes or cuts only make sense when using FamiTracker tempo."
    .error 1
.endif

.ifgt (FAMISTUDIO_EXP_VRC6 + FAMISTUDIO_EXP_VRC7 + FAMISTUDIO_EXP_EPSM + FAMISTUDIO_EXP_MMC5 + FAMISTUDIO_EXP_S5B + FAMISTUDIO_EXP_FDS + FAMISTUDIO_EXP_N163 - 1)
    .msg "Only one audio expansion can be enabled."
    .error 1
.endif

.if FAMISTUDIO_EXP_N163
    .ifeq FAMISTUDIO_EXP_N163_CHN_CNT
        .msg "N163 only supports between 1 and 8 channels."
        .error 1
    .endif
    .ifgt FAMISTUDIO_EXP_N163_CHN_CNT - 8
        .msg "N163 only supports between 1 and 8 channels."
        .error 1
    .endif
.endif
...
.if FAMISTUDIO_USE_DELTA_COUNTER & ~FAMISTUDIO_CFG_DPCM_SUPPORT
    .msg "Delta counter only makes sense if DPCM samples are enabled."
    .error 1
.endif

.if FAMISTUDIO_USE_DPCM_BANKSWITCHING & ~FAMISTUDIO_CFG_DPCM_SUPPORT
    .msg "DPCM bankswitching only makes sense if DPCM samples are enabled."
    .error 1
.endif

FAMISTUDIO_DPCM_PTR = (FAMISTUDIO_DPCM_OFF & 0x3fff) >> 6
...
.endif
.if FAMISTUDIO_EXP_EPSM
.ifgt FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT
EPSM_ENV_CH1_INCREMENT = 4
.else
EPSM_ENV_CH1_INCREMENT = 2
.endif
.ifgt FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT - 1
EPSM_ENV_CH2_INCREMENT = 4
.else
EPSM_ENV_CH2_INCREMENT = 2
.endif
.ifgt FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT - 2
...
.ifle FAMISTUDIO_EXP_N163_CHN_CNT - 4
    FAMISTUDIO_N163_PITCH_SHIFT = 4
.endif
.endif
.ifgt FAMISTUDIO_EXP_N163_CHN_CNT - 1
.ifle FAMISTUDIO_EXP_N163_CHN_CNT - 2
...
famistudio_vrc6_saw_prev_hi:      .ds 1
.else
...
famistudio_chn_epsm_rhythm_volume: .ds FAMISTUDIO_EXP_EPSM_RHYTHM_CNT
famistudio_chn_epsm_rhythm_stereo: .ds FAMISTUDIO_EXP_EPSM_RHYTHM_CNT
.endif
.ifgt FAMISTUDIO_EXP_EPSM_FM_CHN_CNT+FAMISTUDIO_EXP_EPSM_RHYTHM_CNT
famistudio_chn_epsm_trigger:      .ds FAMISTUDIO_EXP_EPSM_FM_CHN_CNT + FAMISTUDIO_EXP_EPSM_RHYTHM_CNT ; bit 0 = new note triggered, bit 7 = note released.
.endif
.ifgt FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_fm_stereo:     .ds FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_fm_instrument: .ds FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_alg:           .ds FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_vol_op1:       .ds FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_vol_op2:       .ds FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_vol_op3:       .ds FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_vol_op4:       .ds FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
.endif
.ifgt FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT
famistudio_epsm_env_period_lo:     .ds 1
famistudio_epsm_env_period_hi:     .ds 1
famistudio_epsm_env_override:      .ds 1
famistudio_epsm_chn_env_shape:     .ds FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT ; bit 7 = note attack.
famistudio_epsm_chn_env_octave:    .ds FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT
.endif
.endif
.if FAMISTUDIO_EXP_N163
famistudio_chn_n163_instrument:   .ds FAMISTUDIO_EXP_N163_CHN_CNT
famistudio_chn_n163_wave_index:   .ds FAMISTUDIO_EXP_N163_CHN_CNT
famistudio_chn_n163_wave_len:     .ds FAMISTUDIO_EXP_N163_CHN_CNT
.endif
.if FAMISTUDIO_EXP_S5B
famistudio_s5b_env_period_lo:     .ds 1
famistudio_s5b_env_period_hi:     .ds 1
famistudio_s5b_env_override:      .ds 1 ; if non zero, it means we had an env period effect this frame.
famistudio_s5b_chn_env_shape:     .ds 3 ; bit 7 = note attack
famistudio_s5b_chn_env_octave:    .ds 3
.endif
...
famistudio_fds_mod_delay_counter: .ds 1
famistudio_fds_override_flags:    .ds 1 ; Bit 7 = mod speed overriden, bit 6 mod depth overriden
.if FAMISTUDIO_USE_FDS_AUTOMOD
famistudio_fds_automod_numer:     .ds 1 ; 0 = auto-mod off.
famistudio_fds_automod_denom:     .ds 1
.endif
.if FAMISTUDIO_USE_PHASE_RESET
famistudio_fds_prev_hi:           .ds 1
.endif
.endif
...
famistudio_ptr0: .ds 2
famistudio_ptr1: .ds 2
.if FAMISTUDIO_EXP_EPSM | FAMISTUDIO_EXP_FDS | FAMISTUDIO_EXP_S5B
famistudio_ptr2: .ds 2
.endif
...
.if FAMISTUDIO_EXP_RAINBOW
FAMISTUDIO_VRC6_PL1_VOL   = 0x41a0
FAMISTUDIO_VRC6_PL1_LO    = 0x41a1
FAMISTUDIO_VRC6_PL1_HI    = 0x41a2
FAMISTUDIO_VRC6_PL2_VOL   = 0x41a3
FAMISTUDIO_VRC6_PL2_LO    = 0x41a4
FAMISTUDIO_VRC6_PL2_HI    = 0x41a5
FAMISTUDIO_VRC6_SAW_VOL   = 0x41a6
FAMISTUDIO_VRC6_SAW_LO    = 0x41a7
FAMISTUDIO_VRC6_SAW_HI    = 0x41a8
.else
...
FAMISTUDIO_MMC5_EXRAM_MODE = 0x5104
...
.if FAMISTUDIO_EXP_EPSM
.ifgt FAMISTUDIO_EXP_EPSM_TRIG_CHN
    lda #0
...
.else
    ...
    .endif
    .endif
    .iflt idx - FAMISTUDIO_VRC6_CH0_IDX
        .ifnb pulse_prev
            .ifeq FAMISTUDIO_CFG_SFX_SUPPORT
                .ifnb reg_sweep
        ...
        .endif
    .endif
    .ifgt idx - FAMISTUDIO_VRC6_CH2_IDX
        .ifnb pulse_prev
            .ifeq FAMISTUDIO_CFG_SFX_SUPPORT
                .ifnb reg_sweep
                    .if FAMISTUDIO_CFG_SMOOTH_VIBRATO
...
famistudio_mul:
    ...
    lda #0x00
    tay
    beq .famistudio_mul_enter_loop
.famistudio_mul_do_add:
    clc
    adc *.num1+0
    tax
    tya
...
.famistudio_mul_loop:
    asl *.num1+0
    rol *.num1+1
.famistudio_mul_enter_loop:
    lsr *.num2
    bcs .famistudio_mul_do_add
    bne .famistudio_mul_loop
    rts
...
famistudio_div:
    ...
    ldx #16
    lda #0
.famistudio_div_divloop:
    asl *.dividend
    rol *.dividend+1
    rol
    cmp *.divisor
    bcc .famistudio_div_no_sub
    sbc *.divisor
    inc *.dividend
.famistudio_div_no_sub:
    dex
    bne .famistudio_div_divloop
    rts
...
famistudio_vrc7_reg_table_lo:
    .db FAMISTUDIO_VRC7_REG_LO_1, FAMISTUDIO_VRC7_REG_LO_2, FAMISTUDIO_VRC7_REG_LO_3, FAMISTUDIO_VRC7_REG_LO_4, FAMISTUDIO_VRC7_REG_LO_5, FAMISTUDIO_VRC7_REG_LO_6
famistudio_vrc7_reg_table_hi:
    .db FAMISTUDIO_VRC7_REG_HI_1, FAMISTUDIO_VRC7_REG_HI_2, FAMISTUDIO_VRC7_REG_HI_3, FAMISTUDIO_VRC7_REG_HI_4, FAMISTUDIO_VRC7_REG_HI_5, FAMISTUDIO_VRC7_REG_HI_6
famistudio_vrc7_vol_table:
    .db FAMISTUDIO_VRC7_REG_VOL_1, FAMISTUDIO_VRC7_REG_VOL_2, FAMISTUDIO_VRC7_REG_VOL_3, FAMISTUDIO_VRC7_REG_VOL_4, FAMISTUDIO_VRC7_REG_VOL_5, FAMISTUDIO_VRC7_REG_VOL_6
famistudio_vrc7_env_table:
    .db FAMISTUDIO_VRC7_CH0_ENVS, FAMISTUDIO_VRC7_CH1_ENVS, FAMISTUDIO_VRC7_CH2_ENVS, FAMISTUDIO_VRC7_CH3_ENVS, FAMISTUDIO_VRC7_CH4_ENVS, FAMISTUDIO_VRC7_CH5_ENVS 
...
famistudio_epsm_vol_table_op1:
    .db FAMISTUDIO_EPSM_REG_TL, FAMISTUDIO_EPSM_REG_TL+1, FAMISTUDIO_EPSM_REG_TL+2,FAMISTUDIO_EPSM_REG_TL, FAMISTUDIO_EPSM_REG_TL+1, FAMISTUDIO_EPSM_REG_TL+2
famistudio_epsm_vol_table_op2:
    .db FAMISTUDIO_EPSM_REG_TL+8, FAMISTUDIO_EPSM_REG_TL+1+8, FAMISTUDIO_EPSM_REG_TL+2+8,FAMISTUDIO_EPSM_REG_TL+8, FAMISTUDIO_EPSM_REG_TL+1+8, FAMISTUDIO_EPSM_REG_TL+2+8
famistudio_epsm_vol_table_op3:
    .db FAMISTUDIO_EPSM_REG_TL+4, FAMISTUDIO_EPSM_REG_TL+1+4, FAMISTUDIO_EPSM_REG_TL+2+4,FAMISTUDIO_EPSM_REG_TL+4, FAMISTUDIO_EPSM_REG_TL+1+4, FAMISTUDIO_EPSM_REG_TL+2+4
famistudio_epsm_vol_table_op4:
    .db FAMISTUDIO_EPSM_REG_TL+12, FAMISTUDIO_EPSM_REG_TL+1+12, FAMISTUDIO_EPSM_REG_TL+2+12,FAMISTUDIO_EPSM_REG_TL+12, FAMISTUDIO_EPSM_REG_TL+1+12, FAMISTUDIO_EPSM_REG_TL+2+12
famistudio_epsm_fm_vol_table:
    .db 0x7e, 0x65, 0x50, 0x3f, 0x32, 0x27, 0x1e, 0x17, 0x12, 0x0d, 0x09, 0x06, 0x04, 0x02, 0x01, 0x00
famistudio_epsm_fm_stereo_reg_table:
    .db 0xb4,0xb5,0xb6,0xb4,0xb5,0xb6
...
famistudio_epsm_rhythm_reg_table:
    .db FAMISTUDIO_EPSM_REG_RHY_BD, FAMISTUDIO_EPSM_REG_RHY_SD, FAMISTUDIO_EPSM_REG_RHY_TC, FAMISTUDIO_EPSM_REG_RHY_HH, FAMISTUDIO_EPSM_REG_RHY_TOM, FAMISTUDIO_EPSM_REG_RHY_RIM
.endif
.ifgt FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_epsm_reg_table_lo:
    .db FAMISTUDIO_EPSM_REG_FN_LO, FAMISTUDIO_EPSM_REG_FN_LO2, FAMISTUDIO_EPSM_REG_FN_LO3, FAMISTUDIO_EPSM_REG_FN_LO, FAMISTUDIO_EPSM_REG_FN_LO2, FAMISTUDIO_EPSM_REG_FN_LO3
famistudio_epsm_reg_table_hi:
    .db FAMISTUDIO_EPSM_REG_FN_HI, FAMISTUDIO_EPSM_REG_FN_HI2, FAMISTUDIO_EPSM_REG_FN_HI3, FAMISTUDIO_EPSM_REG_FN_HI, FAMISTUDIO_EPSM_REG_FN_HI2, FAMISTUDIO_EPSM_REG_FN_HI3
famistudio_epsm_vol_table:
    .db FAMISTUDIO_EPSM_REG_VOL_1, FAMISTUDIO_EPSM_REG_VOL_2, FAMISTUDIO_EPSM_REG_VOL_3, FAMISTUDIO_EPSM_REG_VOL_4, FAMISTUDIO_EPSM_REG_VOL_5, FAMISTUDIO_EPSM_REG_VOL_6
famistudio_epsm_fm_env_table:
    .db FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET
    .db FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET + 2
    .db FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET + 4
    .db FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET + 6
    .db FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET + 8
    .db FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET + 10
famistudio_epsm_register_order:
    .db 0xB0, 0xB4, 0x30, 0x50, 0x60, 0x70, 0x80, 0x90, 0x38, 0x58, 0x68, 0x78, 0x88, 0x98, 0x34, 0x54, 0x64, 0x74, 0x84, 0x94, 0x3c, 0x5c, 0x6c, 0x7c, 0x8c, 0x9c, 0x40, 0x48, 0x44, 0x4c, 0x22 ;40,48,44,4c replaced for not sending data there during instrument updates
famistudio_epsm_channel_key_table:
    .db 0xf0, 0xf1, 0xf2, 0xf4, 0xf5, 0xf6
.endif
.ifgt FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT
famistudio_epsm_sqr_reg_table_lo:
    .db FAMISTUDIO_EPSM_REG_LO_A, FAMISTUDIO_EPSM_REG_LO_B, FAMISTUDIO_EPSM_REG_LO_C
famistudio_epsm_sqr_reg_table_hi:
    .db FAMISTUDIO_EPSM_REG_HI_A, FAMISTUDIO_EPSM_REG_HI_B, FAMISTUDIO_EPSM_REG_HI_C
famistudio_epsm_square_vol_table:
    .db FAMISTUDIO_EPSM_REG_VOL_A, FAMISTUDIO_EPSM_REG_VOL_B, FAMISTUDIO_EPSM_REG_VOL_C
famistudio_epsm_square_env_table:
    .db FAMISTUDIO_EPSM_CH0_ENVS, FAMISTUDIO_EPSM_CH1_ENVS, FAMISTUDIO_EPSM_CH2_ENVS
...
famistudio_update_epsm_square_channel_sound:
    ...
    cpy #0
    bne .famistudio_update_epsm_square_channel_sound_not_first_channel
    sty *.env_shape
    sty *.noise_freq
    sty *.attack
    lda #0x80 ; This mean 'manual pitch'
    sty *.env_octave

.famistudio_update_epsm_square_channel_sound_not_first_channel:
    ldx #0 ; This will fetch volume 0.
    stx *.env_bit
    lda famistudio_chn_note+FAMISTUDIO_EPSM_CH0_IDX,y
    bne .famistudio_update_epsm_square_channel_sound_nocut
    jmp .famistudio_update_epsm_square_channel_sound_update_volume

.famistudio_update_epsm_square_channel_sound_nocut:
    ...
    bne .famistudio_update_epsm_square_channel_sound_nonoise
    lda famistudio_env_value+FAMISTUDIO_ENV_NOISE_IDX_OFF,x
    sta *.noise_freq
.famistudio_update_epsm_square_channel_sound_nonoise:
    lda famistudio_chn_note+FAMISTUDIO_EPSM_CH0_IDX,y
    ; Read note, apply arpeggio 
    clc
    ldx famistudio_epsm_square_env_table,y
    ...
    and #0x0f
    beq .famistudio_update_epsm_square_channel_sound_noenv
    sta *.env_shape
    ...
    sta *.env_octave
    cmp #0x80 ; This mean 'manual pitch'
    beq .famistudio_update_epsm_square_channel_sound_manual_period

    .famistudio_update_epsm_square_channel_sound_auto_period:
        lda *.pitch+0
        sta *.env_period+0
        lda *.pitch+1
        sta *.env_period+1
        jmp .famistudio_update_epsm_square_channel_sound_set_envelope_volume_flag

    .famistudio_update_epsm_square_channel_sound_manual_period:
        lda famistudio_epsm_env_period_lo
        sta *.env_period+0
        lda famistudio_epsm_env_period_hi
        sta *.env_period+1

.famistudio_update_epsm_square_channel_sound_set_envelope_volume_flag:
    lda #0x10

.famistudio_update_epsm_square_channel_sound_noenv:
    sta *.env_bit
...
.famistudio_update_epsm_square_channel_sound_update_volume:
    ; Write volume
...
.famistudio_update_epsm_square_channel_sound_write_shared_registers:
    ; Channel 2 writes all 5 shared registers.
    cpy #(FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT - 1)
    bne .famistudio_update_epsm_square_channel_sound_done
    lda *.env_shape
    beq .famistudio_update_epsm_square_channel_sound_write_shared_noise
    ldx *.env_octave
    cpx #0x80
    beq .famistudio_update_epsm_square_channel_sound_write_shared_env_register

.famistudio_update_epsm_square_channel_sound_compute_auto_period:
    cpx #0
    beq .famistudio_update_epsm_square_channel_sound_write_shared_env_register
    bpl .famistudio_update_epsm_square_channel_sound_positive_octave_loop
    
    .famistudio_update_epsm_square_channel_sound_negative_octave_loop:
            asl *.env_period+0
            rol *.env_period+1
            inx
            bne .famistudio_update_epsm_square_channel_sound_negative_octave_loop
        beq .famistudio_update_epsm_square_channel_sound_write_shared_env_register
        
    .famistudio_update_epsm_square_channel_sound_positive_octave_loop:
        cpx #1
        bne .famistudio_update_epsm_square_channel_sound_do_shift
        .famistudio_update_epsm_square_channel_sound_rounding:
            lda *.env_period+0
            and #1
            beq .famistudio_update_epsm_square_channel_sound_do_shift
            lda *.env_period+0
            clc
            adc #1
            sta *.env_period+0
            bcc .famistudio_update_epsm_square_channel_sound_do_shift
            inc *.env_period+1
        .famistudio_update_epsm_square_channel_sound_do_shift:
            lsr *.env_period+1
            ror *.env_period+0
            dex
            bne .famistudio_update_epsm_square_channel_sound_positive_octave_loop

.famistudio_update_epsm_square_channel_sound_write_shared_env_register:    
    ...
    lda *.attack
    bpl .famistudio_update_epsm_square_channel_sound_write_shared_noise
        lda #FAMISTUDIO_EPSM_REG_SHAPE
        sta FAMISTUDIO_EPSM_ADDR
        lda *.env_shape
        sta FAMISTUDIO_EPSM_DATA

.famistudio_update_epsm_square_channel_sound_write_shared_noise:

    ; Tone/noise enabled.
    lda #FAMISTUDIO_EPSM_REG_TONE
    sta FAMISTUDIO_EPSM_ADDR
.ifeq FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT - 3
...
.famistudio_update_epsm_square_channel_sound_done:
    rts
...
.famistudio_update_epsm_fm_channel_sound_check_cut:

    lda famistudio_chn_note+FAMISTUDIO_EPSM_CHAN_FM_START,y
    bne .famistudio_update_epsm_fm_channel_sound_nocut

.famistudio_update_epsm_fm_channel_sound_cut:
    ; Untrigger note.  
...
.famistudio_update_epsm_fm_channel_sound_nocut:
...
;        rts
    ...
    ; Apply pitch envelope, fine pitch & slides
    .local .FAMISTUDIO_FM_PITCH_ENV_INDEX 
    .FAMISTUDIO_FM_PITCH_ENV_INDEX = FAMISTUDIO_EPSM_CH0_PITCH_ENV_IDX + FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT
    famistudio_get_note_pitch_macro .FAMISTUDIO_FM_PITCH_ENV_INDEX, FAMISTUDIO_EPSM_PITCH_SHIFT, famistudio_epsm_note_table_lsb, famistudio_epsm_note_table_msb
    ...
    bcc .famistudio_update_epsm_fm_channel_sound_octave_done
    .famistudio_update_epsm_fm_channel_sound_compute_octave_loop:
        inx
        lsr
        ror *.pitch+0
        cmp #0x02
        bcc .famistudio_update_epsm_fm_channel_sound_octave_done
        bcs .famistudio_update_epsm_fm_channel_sound_compute_octave_loop ;unconditional
    .famistudio_update_epsm_fm_channel_sound_octave_done:
    sta *.pitch+1
    ...
    .famistudio_update_epsm_fm_channel_sound_write_hi_period:
    ...
    .famistudio_update_epsm_fm_channel_sound_update_volume:
    ldx *.vol_offset
    ...
    .save_op4:
        ...
        clc
        lda famistudio_chn_epsm_trigger,y
        bpl .famistudio_update_epsm_fm_channel_sound_no_release

.famistudio_update_epsm_fm_channel_sound_release:
        ; Untrigger note.  
        lda #FAMISTUDIO_EPSM_REG_KEY
        sta FAMISTUDIO_EPSM_REG_SEL0
        ...
        rts
.famistudio_update_epsm_fm_channel_sound_no_release:
        lda #0
...
;======================================================================================================================
.macro famistudio_epsm_write_patch_registers select, write, ?.loop_main_patch, ?.loop_extra_patch, ?.alg_4, ?.alg_5_6, ?.alg_0_1_2_3
...
.fm_channel:
    ...
    .last_reg:
        ...
        lda #0x22 ; famistudio_epsm_register_order,x
        clc
        adc *.reg_offset
        sta FAMISTUDIO_EPSM_REG_SEL0
        lda [*.ex_patch],y
...
famistudio_update_epsm_rhythm_channel_sound:
    ...
    bne .famistudio_update_epsm_rhythm_channel_sound_nocut
    sta famistudio_chn_epsm_trigger+FAMISTUDIO_EXP_EPSM_FM_CHN_CNT,y
    ldx #0 ; This will fetch volume 0.
    beq .famistudio_update_epsm_rhythm_channel_sound_noupdate

.famistudio_update_epsm_rhythm_channel_sound_nocut:
...
.famistudio_update_epsm_rhythm_channel_sound_update_volume:
    ; Write volume
...
.famistudio_update_epsm_rhythm_channel_sound_noupdate:
    rts
...
famistudio_n163_freq_table_lo:
    .db FAMISTUDIO_N163_REG_FREQ_LO - 0x00
    .db FAMISTUDIO_N163_REG_FREQ_LO - 0x08
    .db FAMISTUDIO_N163_REG_FREQ_LO - 0x10
    .db FAMISTUDIO_N163_REG_FREQ_LO - 0x18
    .db FAMISTUDIO_N163_REG_FREQ_LO - 0x20
    .db FAMISTUDIO_N163_REG_FREQ_LO - 0x28
    .db FAMISTUDIO_N163_REG_FREQ_LO - 0x30
    .db FAMISTUDIO_N163_REG_FREQ_LO - 0x38
famistudio_n163_freq_table_mid:
    .db FAMISTUDIO_N163_REG_FREQ_MID - 0x00
    .db FAMISTUDIO_N163_REG_FREQ_MID - 0x08
    .db FAMISTUDIO_N163_REG_FREQ_MID - 0x10
    .db FAMISTUDIO_N163_REG_FREQ_MID - 0x18
    .db FAMISTUDIO_N163_REG_FREQ_MID - 0x20
    .db FAMISTUDIO_N163_REG_FREQ_MID - 0x28
    .db FAMISTUDIO_N163_REG_FREQ_MID - 0x30
    .db FAMISTUDIO_N163_REG_FREQ_MID - 0x38
famistudio_n163_freq_table_hi:
    .db FAMISTUDIO_N163_REG_FREQ_HI - 0x00
    .db FAMISTUDIO_N163_REG_FREQ_HI - 0x08
    .db FAMISTUDIO_N163_REG_FREQ_HI - 0x10
    .db FAMISTUDIO_N163_REG_FREQ_HI - 0x18
    .db FAMISTUDIO_N163_REG_FREQ_HI - 0x20
    .db FAMISTUDIO_N163_REG_FREQ_HI - 0x28
    .db FAMISTUDIO_N163_REG_FREQ_HI - 0x30
    .db FAMISTUDIO_N163_REG_FREQ_HI - 0x38
famistudio_n163_vol_table:
    .db FAMISTUDIO_N163_REG_VOLUME - 0x00
    .db FAMISTUDIO_N163_REG_VOLUME - 0x08
    .db FAMISTUDIO_N163_REG_VOLUME - 0x10
    .db FAMISTUDIO_N163_REG_VOLUME - 0x18
    .db FAMISTUDIO_N163_REG_VOLUME - 0x20
    .db FAMISTUDIO_N163_REG_VOLUME - 0x28
    .db FAMISTUDIO_N163_REG_VOLUME - 0x30
    .db FAMISTUDIO_N163_REG_VOLUME - 0x38    
famistudio_n163_env_table:
    .db FAMISTUDIO_N163_CH0_ENVS
    .db FAMISTUDIO_N163_CH1_ENVS
    .db FAMISTUDIO_N163_CH2_ENVS
    .db FAMISTUDIO_N163_CH3_ENVS
    .db FAMISTUDIO_N163_CH4_ENVS
    .db FAMISTUDIO_N163_CH5_ENVS
    .db FAMISTUDIO_N163_CH6_ENVS
    .db FAMISTUDIO_N163_CH7_ENVS
.if FAMISTUDIO_USE_PHASE_RESET
famistudio_n163_phase_table_lo:
    .db FAMISTUDIO_N163_REG_PHASE_LO - 0x00
    .db FAMISTUDIO_N163_REG_PHASE_LO - 0x08
    .db FAMISTUDIO_N163_REG_PHASE_LO - 0x10
    .db FAMISTUDIO_N163_REG_PHASE_LO - 0x18
    .db FAMISTUDIO_N163_REG_PHASE_LO - 0x20
    .db FAMISTUDIO_N163_REG_PHASE_LO - 0x28
    .db FAMISTUDIO_N163_REG_PHASE_LO - 0x30
    .db FAMISTUDIO_N163_REG_PHASE_LO - 0x38
famistudio_n163_phase_table_mid:
    .db FAMISTUDIO_N163_REG_PHASE_MID - 0x00
    .db FAMISTUDIO_N163_REG_PHASE_MID - 0x08
    .db FAMISTUDIO_N163_REG_PHASE_MID - 0x10
    .db FAMISTUDIO_N163_REG_PHASE_MID - 0x18
    .db FAMISTUDIO_N163_REG_PHASE_MID - 0x20
    .db FAMISTUDIO_N163_REG_PHASE_MID - 0x28
    .db FAMISTUDIO_N163_REG_PHASE_MID - 0x30
    .db FAMISTUDIO_N163_REG_PHASE_MID - 0x38
famistudio_n163_phase_table_hi:
    .db FAMISTUDIO_N163_REG_PHASE_HI - 0x00
    .db FAMISTUDIO_N163_REG_PHASE_HI - 0x08
    .db FAMISTUDIO_N163_REG_PHASE_HI - 0x10
    .db FAMISTUDIO_N163_REG_PHASE_HI - 0x18
    .db FAMISTUDIO_N163_REG_PHASE_HI - 0x20
    .db FAMISTUDIO_N163_REG_PHASE_HI - 0x28
    .db FAMISTUDIO_N163_REG_PHASE_HI - 0x30
    .db FAMISTUDIO_N163_REG_PHASE_HI - 0x38
.endif
...
famistudio_s5b_reg_table_lo:
    .db FAMISTUDIO_S5B_REG_LO_A, FAMISTUDIO_S5B_REG_LO_B, FAMISTUDIO_S5B_REG_LO_C
famistudio_s5b_reg_table_hi:
    .db FAMISTUDIO_S5B_REG_HI_A, FAMISTUDIO_S5B_REG_HI_B, FAMISTUDIO_S5B_REG_HI_C
famistudio_s5b_vol_table:
    .db FAMISTUDIO_S5B_REG_VOL_A, FAMISTUDIO_S5B_REG_VOL_B, FAMISTUDIO_S5B_REG_VOL_C
famistudio_s5b_env_table:
    .db FAMISTUDIO_S5B_CH0_ENVS, FAMISTUDIO_S5B_CH1_ENVS, FAMISTUDIO_S5B_CH2_ENVS
...
famistudio_update_s5b_channel_sound:
    ...
    ; First channel will clear these, last channel will write the registers.
    cpy #0
    bne .famistudio_update_s5b_channel_sound_not_first_channel
    sty *.env_shape
    sty *.noise_freq
    sty *.attack
    lda #0x80 ; This mean 'manual pitch'
...
.famistudio_update_s5b_channel_sound_not_first_channel:
    ldx #0 ; This will fetch volume 0.
    stx *.env_bit
    lda famistudio_chn_note+FAMISTUDIO_S5B_CH0_IDX,y
    bne .famistudio_update_s5b_channel_sound_nocut
    jmp .famistudio_update_s5b_channel_sound_update_volume

.famistudio_update_s5b_channel_sound_nocut:
    ; Store noise if mixer has it enabled
    ldx famistudio_s5b_env_table,y
    lda famistudio_env_value+FAMISTUDIO_ENV_MIXER_IDX_OFF,x
    and famistudio_s5b_noise_mask,y
    bne .famistudio_update_s5b_channel_sound_nonoise
    lda famistudio_env_value+FAMISTUDIO_ENV_NOISE_IDX_OFF,x
    sta *.noise_freq

.famistudio_update_s5b_channel_sound_nonoise:
    lda famistudio_chn_note+FAMISTUDIO_S5B_CH0_IDX,y
    ; Read note, apply arpeggio 
    clc
    ldx famistudio_s5b_env_table,y
    ...
    and #0x0f
    beq .famistudio_update_s5b_channel_sound_noenv
    sta *.env_shape
    ...
    sta *.env_octave
    cmp #0x80 ; This mean 'manual pitch'
    beq .famistudio_update_s5b_channel_sound_manual_period

    .famistudio_update_s5b_channel_sound_auto_period:
        lda *.pitch+0
        sta *.env_period+0
        lda *.pitch+1
        sta *.env_period+1
        jmp .famistudio_update_s5b_channel_sound_set_envelope_volume_flag

    .famistudio_update_s5b_channel_sound_manual_period:
        lda famistudio_s5b_env_period_lo
        sta *.env_period+0
        lda famistudio_s5b_env_period_hi
        sta *.env_period+1

.famistudio_update_s5b_channel_sound_set_envelope_volume_flag:
    lda #0x10

.famistudio_update_s5b_channel_sound_noenv:
    sta *.env_bit
...
.famistudio_update_s5b_channel_sound_update_volume:
    ; Write volume
...
.famistudio_update_s5b_channel_sound_write_shared_registers:
    ; Channel 2 writes all 5 shared registers.
    cpy #2
    bne .famistudio_update_s5b_channel_sound_done
    lda *.env_shape
    beq .famistudio_update_s5b_channel_sound_write_shared_noise
    ldx *.env_octave
    cpx #0x80
    beq .famistudio_update_s5b_channel_sound_write_shared_env_register

.famistudio_update_s5b_channel_sound_compute_auto_period:
    cpx #0
    beq .famistudio_update_s5b_channel_sound_write_shared_env_register
    bpl .famistudio_update_s5b_channel_sound_positive_octave_loop
    
    .famistudio_update_s5b_channel_sound_negative_octave_loop:
            asl *.env_period+0
            rol *.env_period+1
            inx
            bne .famistudio_update_s5b_channel_sound_negative_octave_loop
        beq .famistudio_update_s5b_channel_sound_write_shared_env_register
        
    .famistudio_update_s5b_channel_sound_positive_octave_loop:
        cpx #1
        bne .famistudio_update_s5b_channel_sound_do_shift
        .famistudio_update_s5b_channel_sound_rounding:
            lda *.env_period+0
            and #1
            beq .famistudio_update_s5b_channel_sound_do_shift
            lda *.env_period+0
            clc
            adc #1
            sta *.env_period+0
            bcc .famistudio_update_s5b_channel_sound_do_shift
            inc *.env_period+1
        .famistudio_update_s5b_channel_sound_do_shift:
            lsr *.env_period+1
            ror *.env_period+0
            dex
            bne .famistudio_update_s5b_channel_sound_positive_octave_loop

.famistudio_update_s5b_channel_sound_write_shared_env_register:    
    ...
    ; Reset envelope if there was an attack.
    lda *.attack
    bpl .famistudio_update_s5b_channel_sound_write_shared_noise
        lda #FAMISTUDIO_S5B_REG_SHAPE
        sta FAMISTUDIO_S5B_ADDR
        lda *.env_shape
        sta FAMISTUDIO_S5B_DATA

.famistudio_update_s5b_channel_sound_write_shared_noise:
...
.famistudio_update_s5b_channel_sound_done:
    rts
...
.macro conditional_phase_reset_regular prev_hi, reg_hi, ?.done
    lsr
    bcc .done
    ldy prev_hi
    sty reg_hi
...
.macro conditional_phase_reset_vrc6 prev_hi, reg_hi, ?.done
    lsr
    bcc .done
    tax
    lda prev_hi
...
.macro conditional_phase_reset_fds prev_hi, reg_hi, ?.done
    lsr
    bcc .done
    lda prev_hi
    ora #0x80
...
famistudio_advance_channel_with_delays:
    ...
    bmi .famistudio_advance_channel_with_delays_done
    sec
    sbc #1
    sta famistudio_chn_cut_delay,x
    bpl .famistudio_advance_channel_with_delays_done ; When wrapping from 0 -> 0xff, we play the note.

    ; Write a stop note.
    lda #0
    sta famistudio_chn_note,x

    .famistudio_advance_channel_with_delays_done:
    rts
...
.ifgt FAMISTUDIO_EXP_EPSM_RHYTHM_CNT
    ...
    .epsm_rhythm_channel_loop:
        ...
        bmi .skip_epsm_rhythm_update ; if the value we load is 0xff then 
...
famistudio_do_fds_note_attack:
    ...
    ; https://www.nesdev.org/wiki/FDS_audio#Mod_frequency_high_(0x4087)
    ; lda #0x80
    ; sta FAMISTUDIO_FDS_MOD_HI
    ; lda #0
...
.endif
    ...
    beq .famistudio_do_note_attack_no_duty
.if FAMISTUDIO_EXP_VRC7 | FAMISTUDIO_EXP_S5B | FAMISTUDIO_EXP_FDS | FAMISTUDIO_EXP_N163 | FAMISTUDIO_EXP_EPSM
    cmp #5
    bcs .famistudio_do_note_attack_no_duty
.endif
.famistudio_do_note_attack_duty:
    lda #0
...
.famistudio_do_note_attack_no_duty:
    ; Pitch envelope
    ldx *.chan_idx
    lda famistudio_channel_to_pitch_env, x
    bmi .famistudio_do_note_attack_no_pitch
    tax

.famistudio_do_note_attack_reset_pitch_env:
    lda #0
    sta famistudio_pitch_env_value_lo,x
    sta famistudio_pitch_env_value_hi,x
    sta famistudio_pitch_env_repeat,x
...
.famistudio_do_note_attack_done:
    ldx *.chan_idx
    rts
...
.if FAMISTUDIO_USE_ARPEGGIO
    ...
    lsr
    ldx *.tmp_x
    bcc .famistudio_load_basic_envelopes_arpeggio_envelope 
    iny ; Instrument arpeggio is overriden by arpeggio, dont touch!
    jmp .famistudio_load_basic_envelopes_duty_envelope
.endif

.famistudio_load_basic_envelopes_arpeggio_envelope:    
    lda [*.instrument_ptr],y
    sta famistudio_env_addr_lo,x
    iny
    lda [*.instrument_ptr],y
...
.famistudio_load_basic_envelopes_duty_envelope:
    ; Duty cycle envelope
    lda *.chan_idx
    cmp #2 ; Triangle has no duty.
    beq .famistudio_load_basic_envelopes_no_duty
.if FAMISTUDIO_EXP_VRC7 | FAMISTUDIO_EXP_S5B | FAMISTUDIO_EXP_FDS | FAMISTUDIO_EXP_N163 | FAMISTUDIO_EXP_EPSM
    cmp #5
    bcs .famistudio_load_basic_envelopes_pitch_envelope
.endif
    .famistudio_load_basic_envelopes_duty:
        inx
        iny
        lda [*.instrument_ptr],y
        sta famistudio_env_addr_lo,x
        ...
        lda [*.instrument_ptr],y
        sta famistudio_env_addr_hi,x
        jmp .famistudio_load_basic_envelopes_pitch_envelope        
    .famistudio_load_basic_envelopes_no_duty:
        iny
        iny

.famistudio_load_basic_envelopes_pitch_envelope:
    ; Pitch envelopes.
...
.endif    
    lda famistudio_channel_to_pitch_env, x
    bmi .famistudio_load_basic_envelopes_done
    tax
.if FAMISTUDIO_USE_VIBRATO 
    ror ; Bring back our bit-7 from above.
    bmi .famistudio_load_basic_envelopes_done ; Instrument pitch is overriden by vibrato, dont touch!
.endif    
    iny
    lda [*.instrument_ptr],y
    sta famistudio_pitch_env_addr_lo,x
...
.famistudio_load_basic_envelopes_done:
    rts
...
famistudio_set_instrument:
    ...
    .ifeq FAMISTUDIO_USE_INSTRUMENT_EXTENDED_RANGE
    asl
    asl
    .endif
...
.if FAMISTUDIO_EXP_FDS | FAMISTUDIO_EXP_VRC7 | FAMISTUDIO_EXP_N163 | FAMISTUDIO_EXP_EPSM | FAMISTUDIO_EXP_S5B
    cpy #5
    bcc .famistudio_set_instrument_base_instrument
    .if FAMISTUDIO_EXP_FDS
    .famistudio_set_instrument_fds_instrument:
        jmp famistudio_set_fds_instrument
    .endif
    .if FAMISTUDIO_EXP_VRC7
    .famistudio_set_instrument_vrc7_instrument:
        jmp famistudio_set_vrc7_instrument
    .endif
    .if FAMISTUDIO_EXP_N163
    .famistudio_set_instrument_n163_instrument:
        jmp famistudio_set_n163_instrument
    .endif
    .if FAMISTUDIO_EXP_S5B
    .famistudio_set_instrument_s5b_instrument:
        jmp famistudio_set_s5b_instrument
    .endif
    .if FAMISTUDIO_EXP_EPSM
    .famistudio_set_instrument_epsm_instrument:
        jmp famistudio_set_epsm_instrument
    .endif
.endif

.famistudio_set_instrument_base_instrument:
...
famistudio_set_vrc7_instrument:
    ...
    jsr famistudio_get_exp_inst_ptr
    bit *.update_flags
    bpl .famistudio_set_vrc7_instrument_load_envelopes

    .famistudio_set_vrc7_instrument_skip_envelopes:
        skip_exp_basic_envelopes
        jmp .famistudio_set_vrc7_instrument_load_patch
    .famistudio_set_vrc7_instrument_load_envelopes:
        jsr famistudio_load_basic_envelopes

    .famistudio_set_vrc7_instrument_load_patch:
    ldx *.chan_idx
    lda [*.ptr],y
    sta famistudio_chn_vrc7_patch-FAMISTUDIO_VRC7_CH0_IDX, x
    bne .famistudio_set_vrc7_instrument_done
    ...
    .famistudio_set_vrc7_instrument_read_patch_loop:
        ...
        inx
        cpx #8
        bne .famistudio_set_vrc7_instrument_read_patch_loop

    .famistudio_set_vrc7_instrument_done:
    rts
...
famistudio_set_s5b_instrument:
    ...
    .famistudio_set_s5b_instrument_mixer:
    sec

    .famistudio_set_s5b_instrument_loop:
        lda [*.ptr],y
        sta famistudio_env_addr_lo,x
        iny
        lda [*.ptr],y
        sta famistudio_env_addr_hi,x
        bcc .famistudio_set_s5b_instrument_load_env_params
        clc
        inx
        iny
        bcc .famistudio_set_s5b_instrument_loop

    .famistudio_set_s5b_instrument_load_env_params:
    ...
    cmp #0x80
    bne .famistudio_set_s5b_instrument_done
    ...
    .famistudio_set_s5b_instrument_done:
    rts
...
.ifgt FAMISTUDIO_EXP_EPSM_RHYTHM_CNT
    ...
    bcc .famistudio_set_epsm_instrument_process_regular_instrument
    ...
    sta famistudio_chn_epsm_rhythm_stereo,x
        ...
        rts
.endif
.famistudio_set_epsm_instrument_process_regular_instrument:
.ifgt FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
    cpy #FAMISTUDIO_EPSM_CHAN_FM_START
    bcc .famistudio_set_epsm_instrument_skip_fm_instrument
        sta famistudio_chn_epsm_fm_instrument-FAMISTUDIO_EPSM_CHAN_FM_START,y
    .famistudio_set_epsm_instrument_skip_fm_instrument:
.endif
    jsr famistudio_get_exp_inst_ptr
    bit *.update_flags
    bpl .famistudio_set_epsm_instrument_load_envelopes

    ; The exporter will ensure this only happens on FM channels.
    .famistudio_set_epsm_instrument_skip_envelopes:
        skip_exp_basic_envelopes
        jmp .famistudio_set_epsm_instrument_check_square_channel
    .famistudio_set_epsm_instrument_load_envelopes:
        jsr famistudio_load_basic_envelopes

    .famistudio_set_epsm_instrument_check_square_channel:
.ifgt FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
    ; channels 0-2 (square) do not need any further handling since they do not support patches
    lda *.chan_idx
    cmp #FAMISTUDIO_EPSM_CHAN_FM_START
    bcs .famistudio_set_epsm_instrument_not_square_channel
        ;lda famistudio_channel_env,x
        ;tax
.endif
.ifgt FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT
        .famistudio_set_epsm_instrument_noise:
        sec

    .famistudio_set_epsm_instrument_loop:
        lda [*.ptr],y
        sta famistudio_env_addr_lo,x
        iny
        lda [*.ptr],y
        sta famistudio_env_addr_hi,x
        bcc .famistudio_set_epsm_instrument_load_env_params
        clc
        inx
        iny
        bcc .famistudio_set_epsm_instrument_loop

    .famistudio_set_epsm_instrument_load_env_params:
        ...
        ; Skip if using auto-period
        cmp #0x80
        bne .famistudio_set_epsm_instrument_done
        ...
        .famistudio_set_epsm_instrument_done:

.endif
        rts

.famistudio_set_epsm_instrument_not_square_channel:
    rts
.endif
...
famistudio_set_fds_instrument:
    ...
    .if FAMISTUDIO_USE_FDS_AUTOMOD
        lda [*.ptr],y
        beq .famistudio_set_fds_instrument_check_mod_speed
...
famistudio_n163_wave_table:
    .db FAMISTUDIO_N163_REG_WAVE - 0x00
    .db FAMISTUDIO_N163_REG_WAVE - 0x08
    .db FAMISTUDIO_N163_REG_WAVE - 0x10
    .db FAMISTUDIO_N163_REG_WAVE - 0x18
    .db FAMISTUDIO_N163_REG_WAVE - 0x20
    .db FAMISTUDIO_N163_REG_WAVE - 0x28
    .db FAMISTUDIO_N163_REG_WAVE - 0x30
    .db FAMISTUDIO_N163_REG_WAVE - 0x38
...
famistudio_update_n163_wave:
    ...
    beq .famistudio_update_n163_wave_done
    ...
    .famistudio_update_n163_wave_done:
    rts
...
famistudio_advance_channel:
    ...
    .local .chan_idx
    .local .tmp_slide_from
    .local .tmp_slide_idx
    .local .tmp_duty_cycle
    .local .tmp_ptr_lo
    .local .tmp_y1
    .local .update_flags
    .local .slide_delta_lo
    .local .tmp_y2
    .local .channel_data_ptr
    .local .opcode_jmp_ptr
    .local .tempo_env_ptr
    .local .env_ptr
    .chan_idx         = famistudio_r0
    .update_flags     = famistudio_r1 ; bit 7 = no attack, bit 6 = has set delayed cut
...
.famistudio_update_channel_check_negative: 
    ora #0
    bmi .famistudio_update_channel_empty_notes_or_instrument_change

; 0x00 to 0x3f = notes from C1 to D6 (most common notes, same as FT2 range)
; 0x40 to 0x6f = opcodes for various things.
.famistudio_update_channel_check_regular_note:
    cmp #0x40
    bcc .famistudio_update_channel_common_note

.if FAMISTUDIO_USE_VOLUME_TRACK
; 0x70 to 0x7f = volume change 
.check_volume_track:
    cmp #0x70
    bcc .famistudio_update_channel_jmp_to_opcode

.famistudio_update_channel_volume_track:    
    and #0x0f
    asl
    asl
    asl
...
.famistudio_update_channel_jmp_to_opcode:
    and #0x3f
    tax
...
.famistudio_update_channel_empty_notes_or_instrument_change:
    and #0x7f
    lsr
    bcs .famistudio_update_channel_set_repeat

.famistudio_update_channel_instrument_change:
...
.famistudio_update_channel_set_repeat:
    sta famistudio_chn_repeat,x ; Set up repeat counter
    bcs .famistudio_update_channel_done 

.famistudio_update_channel_common_note:
    cmp #0
    beq .famistudio_update_channel_play_note
        adc #11 ; Carry is set here.

.famistudio_update_channel_play_note:    
    sta famistudio_chn_note,x ; Store note code

.if FAMISTUDIO_USE_SLIDE_NOTES
.famistudio_update_channel_clear_previous_slide:
    lda famistudio_channel_to_slide,x ; Clear any previous slide on new note.
    bmi .famistudio_update_channel_cancel_delayed_cut
    tax
    lda #0
    sta famistudio_slide_step,x
    ldx *.chan_idx
...
.famistudio_update_channel_cancel_delayed_cut:
.if FAMISTUDIO_USE_FAMITRACKER_DELAYED_NOTES_OR_CUTS
...
.if FAMISTUDIO_CFG_DPCM_SUPPORT
    ...
    cpx #4 
    bne .famistudio_update_channel_check_attack
        lda famistudio_chn_note+4
        bne .famistudio_update_channel_play_sample
        jsr famistudio_sample_stop
        ldx #4
        bne .famistudio_update_channel_done
        .famistudio_update_channel_play_sample:
...
.famistudio_update_channel_done:
    lda famistudio_chn_ref_len,x ; Check reference row counter
    beq .famistudio_update_channel_flush_y                  ; If it is zero, there is no reference
    dec famistudio_chn_ref_len,x ; Decrease row counter
    bne .famistudio_update_channel_flush_y
...
.famistudio_update_channel_flush_y:
...
.opcode_extended_note:
    lda [*.channel_data_ptr],y
    iny
    jmp .famistudio_update_channel_play_note
...
.opcode_end_song:
    lda #0x80 ; TODO : Should we stop, or just call famistudio_music_stop here?
    sta famistudio_song_speed
    jmp .famistudio_update_channel_read_byte
...
.opcode_release_note:
    ...
    jsr .jump_to_release_envelope
    clc
    jmp .famistudio_update_channel_done
.endif
...
.opcode_extended_instrument:
    lda [*.channel_data_ptr],y
    iny
    jmp .famistudio_update_channel_instrument_change
.endif
...
.opcode_note_delay:
    ...
    iny
    sta famistudio_chn_note_delay,x
    jmp .famistudio_update_channel_flush_y
...
.slide_done_pos:
    ...
    sta famistudio_chn_note,x ; Store note code
    iny
    jmp .famistudio_update_channel_cancel_delayed_cut
.endif
...
.famistudio_opcode_jmp_lo:
    .db <(.opcode_extended_note)                ; 0x40
    .db <(.opcode_set_reference)                ; 0x41
    .db <(.opcode_loop)                         ; 0x42
    .db <(.opcode_disable_attack)               ; 0x43
    .db <(.opcode_end_song)                     ; 0x44
.if FAMISTUDIO_USE_RELEASE_NOTES    
    .db <(.opcode_release_note)                 ; 0x45
.else
    .db <(.opcode_invalid)                      ; 0x45
.endif
.if FAMISTUDIO_USE_FAMITRACKER_TEMPO    
    .db <(.opcode_famitracker_speed)            ; 0x46
.else
    .db <(.opcode_invalid)                      ; 0x46
.endif
.if FAMISTUDIO_USE_FAMITRACKER_DELAYED_NOTES_OR_CUTS
    .db <(.opcode_note_delay)                   ; 0x47
    .db <(.opcode_cut_delay)                    ; 0x48
.else
.ifeq FAMISTUDIO_USE_FAMITRACKER_TEMPO
    .db <(.opcode_set_tempo_envelope)           ; 0x47
    .db <(.opcode_reset_tempo_envelope)         ; 0x48
.else
    .db <(.opcode_invalid)                      ; 0x47
    .db <(.opcode_invalid)                      ; 0x48
.endif
.endif
.if FAMISTUDIO_USE_VIBRATO    
    .db <(.opcode_override_pitch_envelope)      ; 0x49
    .db <(.opcode_clear_pitch_override_flag)    ; 0x4a
.else
    .db <(.opcode_invalid)                      ; 0x49
    .db <(.opcode_invalid)                      ; 0x4a
.endif   
.if FAMISTUDIO_USE_ARPEGGIO
    .db <(.opcode_override_arpeggio_envelope)   ; 0x4b
    .db <(.opcode_clear_arpeggio_override_flag) ; 0x4c
    .db <(.opcode_reset_arpeggio)               ; 0x4d
.else
    .db <(.opcode_invalid)                      ; 0x4b
    .db <(.opcode_invalid)                      ; 0x4c
    .db <(.opcode_invalid)                      ; 0x4d
.endif    
.if FAMISTUDIO_USE_PITCH_TRACK
    .db <(.opcode_fine_pitch)                   ; 0x4e
.else
    .db <(.opcode_invalid)                      ; 0x4e
.endif
.if FAMISTUDIO_USE_DUTYCYCLE_EFFECT
    .db <(.opcode_duty_cycle_effect)            ; 0x4f
.else
    .db <(.opcode_invalid)                      ; 0x4f
.endif
.if FAMISTUDIO_USE_SLIDE_NOTES
    .db <(.opcode_slide)                        ; 0x50
.else
    .db <(.opcode_invalid)                      ; 0x50
.endif
.if FAMISTUDIO_USE_VOLUME_SLIDES
    .db <(.opcode_volume_slide)                 ; 0x51
.else
    .db <(.opcode_invalid)                      ; 0x51
.endif
.if FAMISTUDIO_USE_DELTA_COUNTER
    .db <(.opcode_dmc_counter)                  ; 0x52
.else
    .db <(.opcode_invalid)                      ; 0x52
.endif
.if FAMISTUDIO_USE_PHASE_RESET
    .db <(.opcode_phase_reset)                  ; 0x53
.else
    .db <(.opcode_invalid)                      ; 0x53
.endif
.if FAMISTUDIO_USE_INSTRUMENT_EXTENDED_RANGE
    .db <(.opcode_extended_instrument)          ; 0x54
.else
    .db <(.opcode_invalid)                      ; 0x54
.endif
.ifeq FAMISTUDIO_EXP_NONE                            ; Begin expansion-specific opcodes
.if FAMISTUDIO_EXP_VRC6
    .db <(.opcode_vrc6_saw_volume)              ; 0x55
.else
    .db <(.opcode_invalid)                      ; 0x55
.endif
.if FAMISTUDIO_EXP_VRC7 & FAMISTUDIO_USE_RELEASE_NOTES
    .db <(.opcode_vrc7_release_note)            ; 0x56
.else
    .db <(.opcode_invalid)                      ; 0x56
.endif
.if FAMISTUDIO_EXP_FDS
    .db <(.opcode_fds_mod_speed)                ; 0x57
    .db <(.opcode_fds_mod_depth)                ; 0x58
.else
    .db <(.opcode_invalid)                      ; 0x57
    .db <(.opcode_invalid)                      ; 0x58
.endif
.if FAMISTUDIO_EXP_FDS & FAMISTUDIO_USE_RELEASE_NOTES
    .db <(.opcode_fds_release_note)             ; 0x59
.else
    .db <(.opcode_invalid)                      ; 0x59
.endif
.if FAMISTUDIO_EXP_N163 & FAMISTUDIO_USE_RELEASE_NOTES
    .db <(.opcode_n163_release_note)            ; 0x5a
.else
    .db <(.opcode_invalid)                      ; 0x5a
.endif
.if FAMISTUDIO_EXP_N163 & FAMISTUDIO_USE_PHASE_RESET
    .db <(.opcode_n163_phase_reset)             ; 0x5b
.else
    .db <(.opcode_invalid)                      ; 0x5b
.endif
.if FAMISTUDIO_EXP_EPSM & FAMISTUDIO_USE_RELEASE_NOTES
    .db <(.opcode_epsm_release_note)            ; 0x5c
.else
    .db <(.opcode_invalid)                      ; 0x5c
.endif
.if FAMISTUDIO_EXP_EPSM
    .ifgt FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT
        .db <(.opcode_epsm_manual_env_period)       ; 0x5d
    .else
        .db <(.opcode_invalid)                      ; 0x5d
    .endif
.else
    .db <(.opcode_invalid)                          ; 0x5d
.endif
.if FAMISTUDIO_EXP_S5B
    .db <(.opcode_s5b_manual_env_period)        ; 0x5e
.else
    .db <(.opcode_invalid)                      ; 0x5e
.endif
.endif
...
.if FAMISTUDIO_DUAL_SUPPORT
    ...
    bne .famistudio_sfx_init_ntsc
    iny
    iny
.famistudio_sfx_init_ntsc:
.endif
...
.famistudio_sfx_init_set_channels:
    ...
    bne .famistudio_sfx_init_set_channels
...
famistudio_sfx_update:
    ...
    beq .famistudio_sfx_update_no_repeat
    dec famistudio_sfx_repeat,x ; Decrement and return
    bne .famistudio_sfx_update_update_buf ; Just mix with output buffer

.famistudio_sfx_update_no_repeat:
    lda famistudio_sfx_ptr_hi,x ; Check if MSB of the pointer is not zero
    bne .famistudio_sfx_update_sfx_active
    rts ; Return otherwise, no active effect

.famistudio_sfx_update_sfx_active:
...
.famistudio_sfx_update_read_byte:
    lda [*.effect_data_ptr],y ; Read byte of effect
    bmi .famistudio_sfx_update_get_data ; If bit 7 is set, it is a register write
    beq .famistudio_sfx_update_eof
    iny
    bne .famistudio_sfx_update_store_repeat
    jsr .famistudio_sfx_update_inc_sfx
.famistudio_sfx_update_store_repeat:
    sta famistudio_sfx_repeat,x ; If bit 7 is reset, it is number of repeats
    tya
    sta famistudio_sfx_offset,x
    jmp .famistudio_sfx_update_update_buf

.famistudio_sfx_update_get_data:
    iny
    bne .famistudio_sfx_update_get_data2
    jsr .famistudio_sfx_update_inc_sfx
.famistudio_sfx_update_get_data2:
    stx *.tmp ; It is a register write
    adc *.tmp ; Get offset in the effect output buffer
    tax
    lda [*.effect_data_ptr],y
    iny
    bne .famistudio_sfx_update_write_buffer
    stx *.tmpx
    ldx *.tmp
    jsr .famistudio_sfx_update_inc_sfx
    ldx *.tmpx
.famistudio_sfx_update_write_buffer:
    sta famistudio_sfx_buffer-128,x
    ldx *.tmp
    jmp .famistudio_sfx_update_read_byte 

.famistudio_sfx_update_eof:
    sta famistudio_sfx_ptr_hi,x ; Mark channel as inactive

.famistudio_sfx_update_update_buf:
    ...
    and #0x0f
    cmp *.tmp
    bcc .famistudio_sfx_update_no_pulse1
    lda famistudio_sfx_buffer+0,x
...
.famistudio_sfx_update_no_pulse1:
    ...
    and #0x0f
    cmp *.tmp
    bcc .famistudio_sfx_update_no_pulse2
    lda famistudio_sfx_buffer+3,x
...
.famistudio_sfx_update_no_triangle:
    ...
    and #0x0f
    cmp *.tmp
    bcc .famistudio_sfx_update_no_noise
    lda famistudio_sfx_buffer+9,x
    sta famistudio_output_buf+9
    lda famistudio_sfx_buffer+10,x
    sta famistudio_output_buf+10

.famistudio_sfx_update_no_noise:
    rts

.famistudio_sfx_update_inc_sfx:
...
famistudio_dummy_envelope:
    .db 0xc0,0x7f,0x00,0x00

famistudio_dummy_pitch_envelope:
    .db 0x00,0xc0,0x7f,0x00,0x01
...
famistudio_note_table_lsb:
    .if FAMISTUDIO_CFG_PAL_SUPPORT
        .db 0x00
        .db 0x68, 0xb6, 0x0e, 0x6f, 0xd9, 0x4b, 0xc6, 0x48, 0xd1, 0x60, 0xf6, 0x92 ; Octave 0
        .db 0x34, 0xdb, 0x86, 0x37, 0xec, 0xa5, 0x62, 0x23, 0xe8, 0xb0, 0x7b, 0x49 ; Octave 1
        .db 0x19, 0xed, 0xc3, 0x9b, 0x75, 0x52, 0x31, 0x11, 0xf3, 0xd7, 0xbd, 0xa4 ; Octave 2
        .db 0x8c, 0x76, 0x61, 0x4d, 0x3a, 0x29, 0x18, 0x08, 0xf9, 0xeb, 0xde, 0xd1 ; Octave 3
        .db 0xc6, 0xba, 0xb0, 0xa6, 0x9d, 0x94, 0x8b, 0x84, 0x7c, 0x75, 0x6e, 0x68 ; Octave 4
        .db 0x62, 0x5d, 0x57, 0x52, 0x4e, 0x49, 0x45, 0x41, 0x3e, 0x3a, 0x37, 0x34 ; Octave 5
        .db 0x31, 0x2e, 0x2b, 0x29, 0x26, 0x24, 0x22, 0x20, 0x1e, 0x1d, 0x1b, 0x19 ; Octave 6
        .db 0x18, 0x16, 0x15, 0x14, 0x13, 0x12, 0x11, 0x10, 0x0f, 0x0e, 0x0d, 0x0c ; Octave 7
    .endif
    .if FAMISTUDIO_CFG_NTSC_SUPPORT
        .db 0x00
        .db 0x5b, 0x9c, 0xe6, 0x3b, 0x9a, 0x01, 0x72, 0xea, 0x6a, 0xf1, 0x7f, 0x13 ; Octave 0
        .db 0xad, 0x4d, 0xf3, 0x9d, 0x4c, 0x00, 0xb8, 0x74, 0x34, 0xf8, 0xbf, 0x89 ; Octave 1
        .db 0x56, 0x26, 0xf9, 0xce, 0xa6, 0x80, 0x5c, 0x3a, 0x1a, 0xfb, 0xdf, 0xc4 ; Octave 2
        .db 0xab, 0x93, 0x7c, 0x67, 0x52, 0x3f, 0x2d, 0x1c, 0x0c, 0xfd, 0xef, 0xe1 ; Octave 3
        .db 0xd5, 0xc9, 0xbd, 0xb3, 0xa9, 0x9f, 0x96, 0x8e, 0x86, 0x7e, 0x77, 0x70 ; Octave 4
        .db 0x6a, 0x64, 0x5e, 0x59, 0x54, 0x4f, 0x4b, 0x46, 0x42, 0x3f, 0x3b, 0x38 ; Octave 5
        .db 0x34, 0x31, 0x2f, 0x2c, 0x29, 0x27, 0x25, 0x23, 0x21, 0x1f, 0x1d, 0x1b ; Octave 6
        .db 0x1a, 0x18, 0x17, 0x15, 0x14, 0x13, 0x12, 0x11, 0x10, 0x0f, 0x0e, 0x0d ; Octave 7
    .endif
...
famistudio_note_table_msb:
    .if FAMISTUDIO_CFG_PAL_SUPPORT
        .db 0x00
        .db 0x0c, 0x0b, 0x0b, 0x0a, 0x09, 0x09, 0x08, 0x08, 0x07, 0x07, 0x06, 0x06 ; Octave 0
        .db 0x06, 0x05, 0x05, 0x05, 0x04, 0x04, 0x04, 0x04, 0x03, 0x03, 0x03, 0x03 ; Octave 1
        .db 0x03, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x01, 0x01, 0x01, 0x01 ; Octave 2
        .db 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00 ; Octave 3
        .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 4
        .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 5
        .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 6
        .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 7
    .endif
    .if FAMISTUDIO_CFG_NTSC_SUPPORT
        .db 0x00
        .db 0x0d, 0x0c, 0x0b, 0x0b, 0x0a, 0x0a, 0x09, 0x08, 0x08, 0x07, 0x07, 0x07 ; Octave 0
        .db 0x06, 0x06, 0x05, 0x05, 0x05, 0x05, 0x04, 0x04, 0x04, 0x03, 0x03, 0x03 ; Octave 1
        .db 0x03, 0x03, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x01, 0x01, 0x01 ; Octave 2
        .db 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00 ; Octave 3
        .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 4
        .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 5
        .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 6
        .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 7
...
famistudio_saw_note_table_lsb:
    .db 0x00
    .db 0x44, 0x69, 0x9a, 0xd6, 0x1e, 0x70, 0xcb, 0x30, 0x9e, 0x13, 0x91, 0x16 ; Octave 0
    .db 0xa2, 0x34, 0xcc, 0x6b, 0x0e, 0xb7, 0x65, 0x18, 0xce, 0x89, 0x48, 0x0a ; Octave 1
    .db 0xd0, 0x99, 0x66, 0x35, 0x07, 0xdb, 0xb2, 0x8b, 0x67, 0x44, 0x23, 0x05 ; Octave 2
    .db 0xe8, 0xcc, 0xb2, 0x9a, 0x83, 0x6d, 0x59, 0x45, 0x33, 0x22, 0x11, 0x02 ; Octave 3
    .db 0xf3, 0xe6, 0xd9, 0xcc, 0xc1, 0xb6, 0xac, 0xa2, 0x99, 0x90, 0x88, 0x80 ; Octave 4
    .db 0x79, 0x72, 0x6c, 0x66, 0x60, 0x5b, 0x55, 0x51, 0x4c, 0x48, 0x44, 0x40 ; Octave 5
    .db 0x3c, 0x39, 0x35, 0x32, 0x2f, 0x2d, 0x2a, 0x28, 0x25, 0x23, 0x21, 0x1f ; Octave 6
    .db 0x1e, 0x1c, 0x1a, 0x19, 0x17, 0x16, 0x15, 0x13, 0x12, 0x11, 0x10, 0x0f ; Octave 7
famistudio_exp_note_table_msb:
famistudio_saw_note_table_msb:    
    .db 0x00
    .db 0x0f, 0x0e, 0x0d, 0x0c, 0x0c, 0x0b, 0x0a, 0x0a, 0x09, 0x09, 0x08, 0x08 ; Octave 0
    .db 0x07, 0x07, 0x06, 0x06, 0x06, 0x05, 0x05, 0x05, 0x04, 0x04, 0x04, 0x04 ; Octave 1
    .db 0x03, 0x03, 0x03, 0x03, 0x03, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02 ; Octave 2
    .db 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01 ; Octave 3
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 4
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 5
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 6
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 7
...
famistudio_vrc7_note_table_lsb:
    .db 0x00
    .db 0xac, 0xb7, 0xc2, 0xcd, 0xd9, 0xe6, 0xf4, 0x02, 0x12, 0x22, 0x33, 0x46 ; Octave 0
    .db 0x58, 0x6e, 0x84, 0x9a, 0xb2, 0xcc, 0xe8, 0x04, 0x24, 0x44, 0x66, 0x8c ; Octave 1
    .db 0xb0, 0xdc, 0x08, 0x34, 0x64, 0x98, 0xd0, 0x08, 0x48, 0x88, 0xcc, 0x18 ; Octave 2
    .db 0x60, 0xb8, 0x10, 0x68, 0xc8, 0x30, 0xa0, 0x10, 0x90, 0x10, 0x98, 0x30 ; Octave 3
    .db 0xc0, 0x70, 0x20, 0xd0, 0x90, 0x60, 0x40, 0x20, 0x20, 0x20, 0x30, 0x60 ; Octave 4
    .db 0x80, 0xe0, 0x40, 0xa0, 0x20, 0xc0, 0x80, 0x40, 0x40, 0x40, 0x60, 0xc0 ; Octave 5
    .db 0x00, 0xc0, 0x80, 0x40, 0x40, 0x80, 0x00, 0x80, 0x80, 0x80, 0xc0, 0x80 ; Octave 6
    .db 0x00, 0x80, 0x00, 0x80, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00 ; Octave 7
famistudio_exp_note_table_msb:
famistudio_vrc7_note_table_msb:
    .db 0x00
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01 ; Octave 0
    .db 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x02, 0x02 ; Octave 1
    .db 0x02, 0x02, 0x03, 0x03, 0x03, 0x03, 0x03, 0x04, 0x04, 0x04, 0x04, 0x05 ; Octave 2
    .db 0x05, 0x05, 0x06, 0x06, 0x06, 0x07, 0x07, 0x08, 0x08, 0x09, 0x09, 0x0a ; Octave 3
    .db 0x0a, 0x0b, 0x0c, 0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14 ; Octave 4
    .db 0x15, 0x16, 0x18, 0x19, 0x1b, 0x1c, 0x1e, 0x20, 0x22, 0x24, 0x26, 0x28 ; Octave 5
    .db 0x2b, 0x2d, 0x30, 0x33, 0x36, 0x39, 0x3d, 0x40, 0x44, 0x48, 0x4c, 0x51 ; Octave 6
    .db 0x56, 0x5b, 0x61, 0x66, 0x6c, 0x73, 0x7a, 0x81, 0x89, 0x91, 0x99, 0xa3 ; Octave 7    
.endif
...
famistudio_epsm_note_table_lsb:
    .db 0x00
    .db 0x9a, 0xa3, 0xad, 0xb7, 0xc2, 0xcd, 0xda, 0xe7, 0xf4, 0x03, 0x12, 0x23 ; Octave 0
    .db 0x34, 0x46, 0x5a, 0x6e, 0x84, 0x9a, 0xb4, 0xce, 0xe8, 0x06, 0x24, 0x46 ; Octave 1
    .db 0x68, 0x8c, 0xb4, 0xdc, 0x08, 0x34, 0x68, 0x9c, 0xd0, 0x0c, 0x48, 0x8c ; Octave 2
    .db 0xd0, 0x18, 0x68, 0xb8, 0x10, 0x68, 0xd0, 0x38, 0xa0, 0x18, 0x90, 0x18 ; Octave 3
    .db 0xa0, 0x30, 0xd0, 0x70, 0x20, 0xd0, 0xa0, 0x70, 0x40, 0x30, 0x20, 0x30 ; Octave 4
    .db 0x40, 0x60, 0xa0, 0xe0, 0x40, 0xa0, 0x40, 0xe0, 0x80, 0x60, 0x40, 0x60 ; Octave 5
    .db 0x80, 0xc0, 0x40, 0xc0, 0x80, 0x40, 0x80, 0xc0, 0x00, 0xc0, 0x80, 0xc0 ; Octave 6
    .db 0x00, 0x80, 0x80, 0x80, 0x00, 0x80, 0x00, 0x80, 0x00, 0x80, 0x00, 0x80 ; Octave 7
famistudio_epsm_note_table_msb:
    .db 0x00
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01 ; Octave 0
    .db 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02 ; Octave 1
    .db 0x02, 0x02, 0x02, 0x02, 0x03, 0x03, 0x03, 0x03, 0x03, 0x04, 0x04, 0x04 ; Octave 2
    .db 0x04, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x07, 0x07, 0x08, 0x08, 0x09 ; Octave 3
    .db 0x09, 0x0a, 0x0a, 0x0b, 0x0c, 0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12 ; Octave 4
    .db 0x13, 0x14, 0x15, 0x16, 0x18, 0x19, 0x1b, 0x1c, 0x1e, 0x20, 0x22, 0x24 ; Octave 5
    .db 0x26, 0x28, 0x2b, 0x2d, 0x30, 0x33, 0x36, 0x39, 0x3d, 0x40, 0x44, 0x48 ; Octave 6
    .db 0x4d, 0x51, 0x56, 0x5b, 0x61, 0x66, 0x6d, 0x73, 0x7a, 0x81, 0x89, 0x91 ; Octave 7  
	.endif
famistudio_exp_note_table_lsb:
famistudio_epsm_s_note_table_lsb:
    .db 0x00
    .db 0xdd, 0x2f, 0x9a, 0x1c, 0xb3, 0x5f, 0x1d, 0xee, 0xd0, 0xc1, 0xc2, 0xd2 ; Octave 0
    .db 0xee, 0x18, 0x4d, 0x8e, 0xda, 0x2f, 0x8f, 0xf7, 0x68, 0xe1, 0x61, 0xe9 ; Octave 1
    .db 0x77, 0x0c, 0xa7, 0x47, 0xed, 0x98, 0x47, 0xfc, 0xb4, 0x70, 0x31, 0xf4 ; Octave 2
    .db 0xbc, 0x86, 0x53, 0x24, 0xf6, 0xcc, 0xa4, 0x7e, 0x5a, 0x38, 0x18, 0xfa ; Octave 3
    .db 0xde, 0xc3, 0xaa, 0x92, 0x7b, 0x66, 0x52, 0x3f, 0x2d, 0x1c, 0x0c, 0xfd ; Octave 4
    .db 0xef, 0xe1, 0xd5, 0xc9, 0xbe, 0xb3, 0xa9, 0x9f, 0x96, 0x8e, 0x86, 0x7f ; Octave 5
    .db 0x77, 0x71, 0x6a, 0x64, 0x5f, 0x59, 0x54, 0x50, 0x4b, 0x47, 0x43, 0x3f ; Octave 6
    .db 0x3c, 0x38, 0x35, 0x32, 0x2f, 0x2d, 0x2a, 0x28, 0x26, 0x24, 0x22, 0x20 ; Octave 7
famistudio_exp_note_table_msb:
famistudio_epsm_s_note_table_msb:
    .db 0x00
    .db 0x1d, 0x1c, 0x1a, 0x19, 0x17, 0x16, 0x15, 0x13, 0x12, 0x11, 0x10, 0x0f ; Octave 0
    .db 0x0e, 0x0e, 0x0d, 0x0c, 0x0b, 0x0b, 0x0a, 0x09, 0x09, 0x08, 0x08, 0x07 ; Octave 1
    .db 0x07, 0x07, 0x06, 0x06, 0x05, 0x05, 0x05, 0x04, 0x04, 0x04, 0x04, 0x03 ; Octave 2
    .db 0x03, 0x03, 0x03, 0x03, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x01 ; Octave 3
    .db 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00 ; Octave 4
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 5
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 6
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 7
.endif
...
famistudio_fds_note_table_lsb:
    .db 0x00
    .db 0x13, 0x14, 0x16, 0x17, 0x18, 0x1a, 0x1b, 0x1d, 0x1e, 0x20, 0x22, 0x24 ; Octave 0
    .db 0x26, 0x29, 0x2b, 0x2e, 0x30, 0x33, 0x36, 0x39, 0x3d, 0x40, 0x44, 0x48 ; Octave 1
    .db 0x4d, 0x51, 0x56, 0x5b, 0x61, 0x66, 0x6c, 0x73, 0x7a, 0x81, 0x89, 0x91 ; Octave 2
    .db 0x99, 0xa2, 0xac, 0xb6, 0xc1, 0xcd, 0xd9, 0xe6, 0xf3, 0x02, 0x11, 0x21 ; Octave 3
    .db 0x33, 0x45, 0x58, 0x6d, 0x82, 0x99, 0xb2, 0xcb, 0xe7, 0x04, 0x22, 0x43 ; Octave 4
    .db 0x65, 0x8a, 0xb0, 0xd9, 0x04, 0x32, 0x63, 0x97, 0xcd, 0x07, 0x44, 0x85 ; Octave 5
    .db 0xca, 0x13, 0x60, 0xb2, 0x09, 0x65, 0xc6, 0x2d, 0x9b, 0x0e, 0x89, 0x0b ; Octave 6
    .db 0x94, 0x26, 0xc1, 0x64, 0x12, 0xca, 0x8c, 0x5b, 0x35, 0x1d, 0x12, 0x16 ; Octave 7
famistudio_exp_note_table_msb:
famistudio_fds_note_table_msb:
    .db 0x00
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 0
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 1
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ; Octave 2
    .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01 ; Octave 3
    .db 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02 ; Octave 4
    .db 0x02, 0x02, 0x02, 0x02, 0x03, 0x03, 0x03, 0x03, 0x03, 0x04, 0x04, 0x04 ; Octave 5
    .db 0x04, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x07, 0x07, 0x08, 0x08, 0x09 ; Octave 6
    .db 0x09, 0x0a, 0x0a, 0x0b, 0x0c, 0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12 ; Octave 7
.endif
...
.ifeq FAMISTUDIO_EXP_N163_CHN_CNT - 1
    ...
    famistudio_n163_note_table_lsb:
        .db 0x00
        .db 0x47,0x4c,0x50,0x55,0x5a,0x5f,0x65,0x6b,0x72,0x78,0x80,0x87 ; Octave 0
        .db 0x8f,0x98,0xa1,0xaa,0xb5,0xbf,0xcb,0xd7,0xe4,0xf1,0x00,0x0f ; Octave 1
        .db 0x1f,0x30,0x42,0x55,0x6a,0x7f,0x96,0xae,0xc8,0xe3,0x00,0x1e ; Octave 2
        .db 0x3e,0x60,0x85,0xab,0xd4,0xff,0x2c,0x5d,0x90,0xc6,0x00,0x3d ; Octave 3
        .db 0x7d,0xc1,0x0a,0x57,0xa8,0xfe,0x59,0xba,0x20,0x8d,0x00,0x7a ; Octave 4
        .db 0xfb,0x83,0x14,0xae,0x50,0xfd,0xb3,0x74,0x41,0x1a,0x00,0xf4 ; Octave 5
        .db 0xf6,0x07,0x29,0x5c,0xa1,0xfa,0x67,0xe9,0x83,0x35,0x01,0xe8 ; Octave 6
        .db 0xec,0x0f,0x52,0xb8,0x43,0xf4,0xce,0xd3,0x06,0x6a,0x02,0xd1 ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        .db 0x00
        .db 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 ; Octave 0
        .db 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x01 ; Octave 1
        .db 0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x02,0x02 ; Octave 2
        .db 0x02,0x02,0x02,0x02,0x02,0x02,0x03,0x03,0x03,0x03,0x04,0x04 ; Octave 3
        .db 0x04,0x04,0x05,0x05,0x05,0x05,0x06,0x06,0x07,0x07,0x08,0x08 ; Octave 4
        .db 0x08,0x09,0x0a,0x0a,0x0b,0x0b,0x0c,0x0d,0x0e,0x0f,0x10,0x10 ; Octave 5
...
.ifeq FAMISTUDIO_EXP_N163_CHN_CNT - 2
    ...
    famistudio_n163_note_table_lsb:
        .db 0x00
        .db 0x8f,0x98,0xa1,0xaa,0xb5,0xbf,0xcb,0xd7,0xe4,0xf1,0x00,0x0f ; Octave 0
        .db 0x1f,0x30,0x42,0x55,0x6a,0x7f,0x96,0xae,0xc8,0xe3,0x00,0x1e ; Octave 1
        .db 0x3e,0x60,0x85,0xab,0xd4,0xff,0x2c,0x5d,0x90,0xc6,0x00,0x3d ; Octave 2
        .db 0x7d,0xc1,0x0a,0x57,0xa8,0xfe,0x59,0xba,0x20,0x8d,0x00,0x7a ; Octave 3
        .db 0xfb,0x83,0x14,0xae,0x50,0xfd,0xb3,0x74,0x41,0x1a,0x00,0xf4 ; Octave 4
        .db 0xf6,0x07,0x29,0x5c,0xa1,0xfa,0x67,0xe9,0x83,0x35,0x01,0xe8 ; Octave 5
        .db 0xec,0x0f,0x52,0xb8,0x43,0xf4,0xce,0xd3,0x06,0x6a,0x02,0xd1 ; Octave 6
        .db 0xd9,0x1f,0xa5,0x71,0x86,0xe8,0x9c,0xa7,0x0d,0xd5,0x05,0xa2 ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        .db 0x00
        .db 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x01 ; Octave 0
        .db 0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x02,0x02 ; Octave 1
        .db 0x02,0x02,0x02,0x02,0x02,0x02,0x03,0x03,0x03,0x03,0x04,0x04 ; Octave 2
        .db 0x04,0x04,0x05,0x05,0x05,0x05,0x06,0x06,0x07,0x07,0x08,0x08 ; Octave 3
        .db 0x08,0x09,0x0a,0x0a,0x0b,0x0b,0x0c,0x0d,0x0e,0x0f,0x10,0x10 ; Octave 4
        .db 0x11,0x13,0x14,0x15,0x16,0x17,0x19,0x1a,0x1c,0x1e,0x20,0x21 ; Octave 5
...
.ifeq FAMISTUDIO_EXP_N163_CHN_CNT - 3
    ...
    famistudio_n163_note_table_lsb:
        .db 0x00
        .db 0xd7,0xe4,0xf1,0x00,0x0f,0x1f,0x30,0x42,0x56,0x6a,0x80,0x96 ; Octave 0
        .db 0xaf,0xc8,0xe3,0x00,0x1f,0x3f,0x61,0x85,0xac,0xd5,0x00,0x2d ; Octave 1
        .db 0x5e,0x91,0xc7,0x01,0x3e,0x7e,0xc3,0x0b,0x58,0xaa,0x00,0x5b ; Octave 2
        .db 0xbc,0x22,0x8f,0x02,0x7c,0xfd,0x86,0x17,0xb1,0x54,0x00,0xb7 ; Octave 3
        .db 0x78,0x45,0x1f,0x05,0xf9,0xfb,0x0d,0x2f,0x62,0xa8,0x01,0x6e ; Octave 4
        .db 0xf1,0x8b,0x3e,0x0a,0xf2,0xf7,0x1a,0x5e,0xc5,0x50,0x02,0xdc ; Octave 5
        .db 0xe3,0x17,0x7c,0x15,0xe4,0xee,0x35,0xbd,0x8a,0xa0,0x04,0xb9 ; Octave 6
        .db 0xc6,0x2e,0xf8,0x2a,0xc9,0xdc,0x6a,0x7a,0x14,0x40,0x08,0x73 ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        .db 0x00
        .db 0x00,0x00,0x00,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01 ; Octave 0
        .db 0x01,0x01,0x01,0x02,0x02,0x02,0x02,0x02,0x02,0x02,0x03,0x03 ; Octave 1
        .db 0x03,0x03,0x03,0x04,0x04,0x04,0x04,0x05,0x05,0x05,0x06,0x06 ; Octave 2
        .db 0x06,0x07,0x07,0x08,0x08,0x08,0x09,0x0a,0x0a,0x0b,0x0c,0x0c ; Octave 3
        .db 0x0d,0x0e,0x0f,0x10,0x10,0x11,0x13,0x14,0x15,0x16,0x18,0x19 ; Octave 4
        .db 0x1a,0x1c,0x1e,0x20,0x21,0x23,0x26,0x28,0x2a,0x2d,0x30,0x32 ; Octave 5
...
.ifeq FAMISTUDIO_EXP_N163_CHN_CNT - 4
    ...
    famistudio_n163_note_table_lsb:
        .db 0x00
        .db 0x1f,0x30,0x42,0x55,0x6a,0x7f,0x96,0xae,0xc8,0xe3,0x00,0x1e ; Octave 0
        .db 0x3e,0x60,0x85,0xab,0xd4,0xff,0x2c,0x5d,0x90,0xc6,0x00,0x3d ; Octave 1
        .db 0x7d,0xc1,0x0a,0x57,0xa8,0xfe,0x59,0xba,0x20,0x8d,0x00,0x7a ; Octave 2
        .db 0xfb,0x83,0x14,0xae,0x50,0xfd,0xb3,0x74,0x41,0x1a,0x00,0xf4 ; Octave 3
        .db 0xf6,0x07,0x29,0x5c,0xa1,0xfa,0x67,0xe9,0x83,0x35,0x01,0xe8 ; Octave 4
        .db 0xec,0x0f,0x52,0xb8,0x43,0xf4,0xce,0xd3,0x06,0x6a,0x02,0xd1 ; Octave 5
        .db 0xd9,0x1f,0xa5,0x71,0x86,0xe8,0x9c,0xa7,0x0d,0xd5,0x05,0xa2 ; Octave 6
        .db 0xb2,0x3e,0x4b,0xe3,0x0c,0xd0,0x38,0x4e,0x1b,0xab,0xff,0xff ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        .db 0x00
        .db 0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x02,0x02 ; Octave 0
        .db 0x02,0x02,0x02,0x02,0x02,0x02,0x03,0x03,0x03,0x03,0x04,0x04 ; Octave 1
        .db 0x04,0x04,0x05,0x05,0x05,0x05,0x06,0x06,0x07,0x07,0x08,0x08 ; Octave 2
        .db 0x08,0x09,0x0a,0x0a,0x0b,0x0b,0x0c,0x0d,0x0e,0x0f,0x10,0x10 ; Octave 3
        .db 0x11,0x13,0x14,0x15,0x16,0x17,0x19,0x1a,0x1c,0x1e,0x20,0x21 ; Octave 4
        .db 0x23,0x26,0x28,0x2a,0x2d,0x2f,0x32,0x35,0x39,0x3c,0x40,0x43 ; Octave 5
...
.ifeq FAMISTUDIO_EXP_N163_CHN_CNT - 5
    ...
    famistudio_n163_note_table_lsb:
        .db 0x00
        .db 0x67,0x7c,0x93,0xab,0xc4,0xdf,0xfc,0x1a,0x3a,0x5c,0x80,0xa6 ; Octave 0
        .db 0xce,0xf9,0x26,0x56,0x89,0xbf,0xf8,0x34,0x74,0xb8,0x00,0x4c ; Octave 1
        .db 0x9c,0xf2,0x4c,0xac,0x12,0x7e,0xf0,0x69,0xe9,0x70,0x00,0x98 ; Octave 2
        .db 0x39,0xe4,0x99,0x59,0x24,0xfc,0xe0,0xd2,0xd2,0xe1,0x00,0x31 ; Octave 3
        .db 0x73,0xc9,0x33,0xb3,0x49,0xf8,0xc0,0xa4,0xa4,0xc2,0x01,0x62 ; Octave 4
        .db 0xe7,0x93,0x67,0x67,0x93,0xf1,0x81,0x48,0x48,0x85,0x03,0xc5 ; Octave 5
        .db 0xcf,0x26,0xcf,0xce,0x27,0xe2,0x03,0x90,0x91,0x0b,0x06,0x8a ; Octave 6
        .db 0x9f,0x4d,0x9e,0x9c,0x4f,0xc4,0x06,0xff,0xff,0xff,0xff,0xff ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        .db 0x00
        .db 0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x02,0x02,0x02,0x02,0x02 ; Octave 0
        .db 0x02,0x02,0x03,0x03,0x03,0x03,0x03,0x04,0x04,0x04,0x05,0x05 ; Octave 1
        .db 0x05,0x05,0x06,0x06,0x07,0x07,0x07,0x08,0x08,0x09,0x0a,0x0a ; Octave 2
        .db 0x0b,0x0b,0x0c,0x0d,0x0e,0x0e,0x0f,0x10,0x11,0x12,0x14,0x15 ; Octave 3
        .db 0x16,0x17,0x19,0x1a,0x1c,0x1d,0x1f,0x21,0x23,0x25,0x28,0x2a ; Octave 4
        .db 0x2c,0x2f,0x32,0x35,0x38,0x3b,0x3f,0x43,0x47,0x4b,0x50,0x54 ; Octave 5
...
.ifeq FAMISTUDIO_EXP_N163_CHN_CNT - 6
    ...
    famistudio_n163_note_table_lsb:
        .db 0x00
        .db 0xaf,0xc8,0xe3,0x00,0x1f,0x3f,0x61,0x85,0xac,0xd5,0x00,0x2d ; Octave 0
        .db 0x5e,0x91,0xc7,0x01,0x3e,0x7e,0xc3,0x0b,0x58,0xaa,0x00,0x5b ; Octave 1
        .db 0xbc,0x22,0x8f,0x02,0x7c,0xfd,0x86,0x17,0xb1,0x54,0x00,0xb7 ; Octave 2
        .db 0x78,0x45,0x1f,0x05,0xf9,0xfb,0x0d,0x2f,0x62,0xa8,0x01,0x6e ; Octave 3
        .db 0xf1,0x8b,0x3e,0x0a,0xf2,0xf7,0x1a,0x5e,0xc5,0x50,0x02,0xdc ; Octave 4
        .db 0xe3,0x17,0x7c,0x15,0xe4,0xee,0x35,0xbd,0x8a,0xa0,0x04,0xb9 ; Octave 5
        .db 0xc6,0x2e,0xf8,0x2a,0xc9,0xdc,0x6a,0x7a,0x14,0x40,0x08,0x73 ; Octave 6
        .db 0x8c,0x5d,0xf1,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        .db 0x00
        .db 0x01,0x01,0x01,0x02,0x02,0x02,0x02,0x02,0x02,0x02,0x03,0x03 ; Octave 0
        .db 0x03,0x03,0x03,0x04,0x04,0x04,0x04,0x05,0x05,0x05,0x06,0x06 ; Octave 1
        .db 0x06,0x07,0x07,0x08,0x08,0x08,0x09,0x0a,0x0a,0x0b,0x0c,0x0c ; Octave 2
        .db 0x0d,0x0e,0x0f,0x10,0x10,0x11,0x13,0x14,0x15,0x16,0x18,0x19 ; Octave 3
        .db 0x1a,0x1c,0x1e,0x20,0x21,0x23,0x26,0x28,0x2a,0x2d,0x30,0x32 ; Octave 4
        .db 0x35,0x39,0x3c,0x40,0x43,0x47,0x4c,0x50,0x55,0x5a,0x60,0x65 ; Octave 5
...
.ifeq FAMISTUDIO_EXP_N163_CHN_CNT - 7
    ...
    famistudio_n163_note_table_lsb:
        .db 0x00
        .db 0xf6,0x14,0x34,0x56,0x79,0x9f,0xc7,0xf1,0x1e,0x4d,0x80,0xb5 ; Octave 0
        .db 0xed,0x29,0x69,0xac,0xf3,0x3e,0x8e,0xe3,0x3c,0x9b,0x00,0x6a ; Octave 1
        .db 0xdb,0x53,0xd2,0x58,0xe6,0x7d,0x1d,0xc6,0x79,0x37,0x00,0xd5 ; Octave 2
        .db 0xb7,0xa6,0xa4,0xb0,0xcd,0xfa,0x3a,0x8c,0xf3,0x6e,0x01,0xab ; Octave 3
        .db 0x6f,0x4d,0x48,0x61,0x9a,0xf5,0x74,0x19,0xe6,0xdd,0x02,0x56 ; Octave 4
        .db 0xde,0x9b,0x91,0xc3,0x35,0xeb,0xe8,0x32,0xcc,0xbb,0x04,0xad ; Octave 5
        .db 0xbc,0x36,0x22,0x86,0x6b,0xd6,0xd1,0x64,0x98,0x76,0x09,0x5b ; Octave 6
        .db 0x79,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        .db 0x00
        .db 0x01,0x02,0x02,0x02,0x02,0x02,0x02,0x02,0x03,0x03,0x03,0x03 ; Octave 0
        .db 0x03,0x04,0x04,0x04,0x04,0x05,0x05,0x05,0x06,0x06,0x07,0x07 ; Octave 1
        .db 0x07,0x08,0x08,0x09,0x09,0x0a,0x0b,0x0b,0x0c,0x0d,0x0e,0x0e ; Octave 2
        .db 0x0f,0x10,0x11,0x12,0x13,0x14,0x16,0x17,0x18,0x1a,0x1c,0x1d ; Octave 3
        .db 0x1f,0x21,0x23,0x25,0x27,0x29,0x2c,0x2f,0x31,0x34,0x38,0x3b ; Octave 4
        .db 0x3e,0x42,0x46,0x4a,0x4f,0x53,0x58,0x5e,0x63,0x69,0x70,0x76 ; Octave 5
...
.ifeq FAMISTUDIO_EXP_N163_CHN_CNT - 8
    ...
    famistudio_n163_note_table_lsb:
        .db 0x00
        .db 0x3e,0x60,0x85,0xab,0xd4,0xff,0x2c,0x5d,0x90,0xc6,0x00,0x3d ; Octave 0
        .db 0x7d,0xc1,0x0a,0x57,0xa8,0xfe,0x59,0xba,0x20,0x8d,0x00,0x7a ; Octave 1
        .db 0xfb,0x83,0x14,0xae,0x50,0xfd,0xb3,0x74,0x41,0x1a,0x00,0xf4 ; Octave 2
        .db 0xf6,0x07,0x29,0x5c,0xa1,0xfa,0x67,0xe9,0x83,0x35,0x01,0xe8 ; Octave 3
        .db 0xec,0x0f,0x52,0xb8,0x43,0xf4,0xce,0xd3,0x06,0x6a,0x02,0xd1 ; Octave 4
        .db 0xd9,0x1f,0xa5,0x71,0x86,0xe8,0x9c,0xa7,0x0d,0xd5,0x05,0xa2 ; Octave 5
        .db 0xb2,0x3e,0x4b,0xe3,0x0c,0xd0,0x38,0x4e,0x1b,0xab,0xff,0xff ; Octave 6
        .db 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        .db 0x00
        .db 0x02,0x02,0x02,0x02,0x02,0x02,0x03,0x03,0x03,0x03,0x04,0x04 ; Octave 0
        .db 0x04,0x04,0x05,0x05,0x05,0x05,0x06,0x06,0x07,0x07,0x08,0x08 ; Octave 1
        .db 0x08,0x09,0x0a,0x0a,0x0b,0x0b,0x0c,0x0d,0x0e,0x0f,0x10,0x10 ; Octave 2
        .db 0x11,0x13,0x14,0x15,0x16,0x17,0x19,0x1a,0x1c,0x1e,0x20,0x21 ; Octave 3
        .db 0x23,0x26,0x28,0x2a,0x2d,0x2f,0x32,0x35,0x39,0x3c,0x40,0x43 ; Octave 4
        .db 0x47,0x4c,0x50,0x55,0x5a,0x5f,0x65,0x6b,0x72,0x78,0x80,0x87 ; Octave 5
        .db 0x8f,0x98,0xa1,0xaa,0xb5,0xbf,0xcb,0xd7,0xe4,0xf1,0xff,0xff ; Octave 6
        .db 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff ; Octave 7
.endif
.endif
...
famistudio_channel_to_volume_env:
    ...
    .db 0xff
.if FAMISTUDIO_EXP_VRC6
    .db FAMISTUDIO_VRC6_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_VRC6_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_VRC6_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.if FAMISTUDIO_EXP_VRC7
    .db FAMISTUDIO_VRC7_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_VRC7_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_VRC7_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_VRC7_CH3_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_VRC7_CH4_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_VRC7_CH5_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.if FAMISTUDIO_EXP_FDS
    .db FAMISTUDIO_FDS_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.if FAMISTUDIO_EXP_MMC5
    .db FAMISTUDIO_MMC5_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_MMC5_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.if FAMISTUDIO_EXP_N163
    .db FAMISTUDIO_N163_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_N163_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_N163_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_N163_CH3_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_N163_CH4_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_N163_CH5_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_N163_CH6_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_N163_CH7_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.if FAMISTUDIO_EXP_S5B
    .db FAMISTUDIO_S5B_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_S5B_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_S5B_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.if FAMISTUDIO_EXP_EPSM
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 0
    .db FAMISTUDIO_EPSM_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 1
    .db FAMISTUDIO_EPSM_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 2
    .db FAMISTUDIO_EPSM_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 3
    .db FAMISTUDIO_EPSM_CH3_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 4
    .db FAMISTUDIO_EPSM_CH4_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 5
    .db FAMISTUDIO_EPSM_CH5_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 6
    .db FAMISTUDIO_EPSM_CH6_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 7
    .db FAMISTUDIO_EPSM_CH7_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 8
    .db FAMISTUDIO_EPSM_CH8_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
.endif
.endif
...
famistudio_channel_to_arpeggio_env:
    ...
    .db 0xff
.if FAMISTUDIO_EXP_VRC6
    .db FAMISTUDIO_VRC6_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_VRC6_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_VRC6_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.if FAMISTUDIO_EXP_VRC7
    .db FAMISTUDIO_VRC7_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_VRC7_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_VRC7_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_VRC7_CH3_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_VRC7_CH4_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_VRC7_CH5_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.if FAMISTUDIO_EXP_FDS
    .db FAMISTUDIO_FDS_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.if FAMISTUDIO_EXP_MMC5
    .db FAMISTUDIO_MMC5_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_MMC5_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.if FAMISTUDIO_EXP_N163
    .db FAMISTUDIO_N163_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_N163_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_N163_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_N163_CH3_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_N163_CH4_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_N163_CH5_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_N163_CH6_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_N163_CH7_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.if FAMISTUDIO_EXP_S5B
    .db FAMISTUDIO_S5B_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_S5B_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_S5B_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.if FAMISTUDIO_EXP_EPSM
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 0
    .db FAMISTUDIO_EPSM_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 1
    .db FAMISTUDIO_EPSM_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 2
    .db FAMISTUDIO_EPSM_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 3
    .db FAMISTUDIO_EPSM_CH3_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 4
    .db FAMISTUDIO_EPSM_CH4_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 5
    .db FAMISTUDIO_EPSM_CH5_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 6
    .db FAMISTUDIO_EPSM_CH6_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 7
    .db FAMISTUDIO_EPSM_CH7_ENVS+FAMISTUDIO_ENV_NOTE_OFF
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 8
    .db FAMISTUDIO_EPSM_CH8_ENVS+FAMISTUDIO_ENV_NOTE_OFF
...
.if FAMISTUDIO_USE_NOISE_SLIDE_NOTES    
    ...
    .db 0x01
    .db 0x02
    .db FAMISTUDIO_NOISE_SLIDE_INDEX ; Keep the noise slide at the end so the pitch envelopes/slides are in sync.
    .db 0xff ; no slide for DPCM
.if FAMISTUDIO_EXP_VRC6
    .db FAMISTUDIO_VRC6_CH0_PITCH_ENV_IDX
    .db FAMISTUDIO_VRC6_CH1_PITCH_ENV_IDX
    .db FAMISTUDIO_VRC6_CH2_PITCH_ENV_IDX
.endif
.if FAMISTUDIO_EXP_VRC7
    .db FAMISTUDIO_VRC7_CH0_PITCH_ENV_IDX
    .db FAMISTUDIO_VRC7_CH1_PITCH_ENV_IDX
    .db FAMISTUDIO_VRC7_CH2_PITCH_ENV_IDX
    .db FAMISTUDIO_VRC7_CH3_PITCH_ENV_IDX
    .db FAMISTUDIO_VRC7_CH4_PITCH_ENV_IDX
    .db FAMISTUDIO_VRC7_CH5_PITCH_ENV_IDX
.endif
.if FAMISTUDIO_EXP_FDS
    .db FAMISTUDIO_FDS_CH0_PITCH_ENV_IDX
.endif
.if FAMISTUDIO_EXP_MMC5    
    .db FAMISTUDIO_MMC5_CH0_PITCH_ENV_IDX
    .db FAMISTUDIO_MMC5_CH1_PITCH_ENV_IDX
.endif
.if FAMISTUDIO_EXP_N163    
    .db FAMISTUDIO_N163_CH0_PITCH_ENV_IDX
    .db FAMISTUDIO_N163_CH1_PITCH_ENV_IDX
    .db FAMISTUDIO_N163_CH2_PITCH_ENV_IDX
    .db FAMISTUDIO_N163_CH3_PITCH_ENV_IDX
    .db FAMISTUDIO_N163_CH4_PITCH_ENV_IDX
    .db FAMISTUDIO_N163_CH5_PITCH_ENV_IDX
    .db FAMISTUDIO_N163_CH6_PITCH_ENV_IDX
    .db FAMISTUDIO_N163_CH7_PITCH_ENV_IDX
.endif
.if FAMISTUDIO_EXP_S5B    
    .db FAMISTUDIO_S5B_CH0_PITCH_ENV_IDX
    .db FAMISTUDIO_S5B_CH1_PITCH_ENV_IDX
    .db FAMISTUDIO_S5B_CH2_PITCH_ENV_IDX
.endif
.if FAMISTUDIO_EXP_EPSM
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT
    .db FAMISTUDIO_EPSM_CH0_PITCH_ENV_IDX
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 1
    .db FAMISTUDIO_EPSM_CH1_PITCH_ENV_IDX
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 2
    .db FAMISTUDIO_EPSM_CH2_PITCH_ENV_IDX
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 3
    .db FAMISTUDIO_EPSM_CH3_PITCH_ENV_IDX
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 4
    .db FAMISTUDIO_EPSM_CH4_PITCH_ENV_IDX
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 5
    .db FAMISTUDIO_EPSM_CH5_PITCH_ENV_IDX
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 6
    .db FAMISTUDIO_EPSM_CH6_PITCH_ENV_IDX
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 7
    .db FAMISTUDIO_EPSM_CH7_PITCH_ENV_IDX
.endif
.ifgt FAMISTUDIO_EXP_EPSM_ENV_CNT - 8
    .db FAMISTUDIO_EPSM_CH8_PITCH_ENV_IDX
.endif ; FAMISTUDIO_EXP_EPSM_ENV_CNT - 8
.endif ; FAMISTUDIO_EXP_EPSM
...
famistudio_channel_to_pitch_env:
    ...
    .db 0x01
    .db 0x02
    .db 0xff ; no pitch envelopes for noise
    .db 0xff ; no pitch envelopes slide for DPCM
.if FAMISTUDIO_EXP_VRC6
    .db FAMISTUDIO_VRC6_CH0_PITCH_ENV_IDX
    .db FAMISTUDIO_VRC6_CH1_PITCH_ENV_IDX
    .db FAMISTUDIO_VRC6_CH2_PITCH_ENV_IDX
...
famistudio_channel_to_dutycycle:
    ...
    .db 0xff
.if FAMISTUDIO_EXP_VRC6
    .db FAMISTUDIO_VRC6_CH0_DUTY_IDX
    .db FAMISTUDIO_VRC6_CH1_DUTY_IDX
    .db FAMISTUDIO_VRC6_CH2_DUTY_IDX
.endif
.if FAMISTUDIO_EXP_MMC5
    .db FAMISTUDIO_MMC5_CH0_DUTY_IDX
    .db FAMISTUDIO_MMC5_CH1_DUTY_IDX
.endif

; For a given channel, returns the index of the duty cycle envelope.
famistudio_channel_to_duty_env:
    .db FAMISTUDIO_CH0_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    .db FAMISTUDIO_CH1_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    .db 0xff
    .db FAMISTUDIO_CH3_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    .db 0xff
.if FAMISTUDIO_EXP_VRC6
    .db FAMISTUDIO_VRC6_CH0_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    .db FAMISTUDIO_VRC6_CH1_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    .db FAMISTUDIO_VRC6_CH2_ENVS+FAMISTUDIO_ENV_DUTY_OFF
.endif
.if FAMISTUDIO_EXP_MMC5
    .db FAMISTUDIO_MMC5_CH0_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    .db FAMISTUDIO_MMC5_CH1_ENVS+FAMISTUDIO_ENV_DUTY_OFF
.endif
.endif
...
famistudio_tempo_frame_lookup:
    .db 0x01, 0x02 ; NTSC -> NTSC, NTSC -> PAL
    .db 0x00, 0x01 ; PAL  -> NTSC, PAL  -> PAL
.endif
...
famistudio_volume_table:
    ...
    .db 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x02
    .db 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x02, 0x02, 0x03, 0x03, 0x03
    .db 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x02, 0x03, 0x03, 0x03, 0x03, 0x04, 0x04
    .db 0x00, 0x01, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x03, 0x03, 0x03, 0x04, 0x04, 0x04, 0x05, 0x05
    .db 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x03, 0x03, 0x04, 0x04, 0x04, 0x05, 0x05, 0x06, 0x06
    .db 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03, 0x04, 0x04, 0x05, 0x05, 0x06, 0x06, 0x07, 0x07
...
; .db 0xff, 0x00, 0x01, 0xff, 0x02, 0xff
