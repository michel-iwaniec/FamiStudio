...
famistudio_channel_epsm_chan_table:
    .db 0x00, 0x01, 0x02, 0x00, 0x01, 0x02
famistudio_epsm_rhythm_key_table:
    .db 0x01,0x02,0x04,0x08,0x10,0x20
famistudio_epsm_rhythm_env_table:
    .db FAMISTUDIO_EPSM_CH9_ENVS, FAMISTUDIO_EPSM_CH10_ENVS, FAMISTUDIO_EPSM_CH11_ENVS, FAMISTUDIO_EPSM_CH12_ENVS, FAMISTUDIO_EPSM_CH13_ENVS, FAMISTUDIO_EPSM_CH14_ENVS
...
famistudio_epsm_fm_env_table:
    .db FAMISTUDIO_EPSM_CH3_ENVS, FAMISTUDIO_EPSM_CH4_ENVS, FAMISTUDIO_EPSM_CH5_ENVS, FAMISTUDIO_EPSM_CH6_ENVS, FAMISTUDIO_EPSM_CH7_ENVS, FAMISTUDIO_EPSM_CH8_ENVS 
famistudio_epsm_register_order:
    .db 0xB0, 0xB4, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0x90, 0x38, 0x48, 0x58, 0x68, 0x78, 0x88, 0x98, 0x34, 0x44, 0x54, 0x64, 0x74, 0x84, 0x94, 0x3c, 0x4c, 0x5c, 0x6c, 0x7c, 0x8c, 0x9c, 0x22 ;40,48,44,4c replaced for not sending data there during instrument updates
...
.famistudio_update_epsm_fm_channel_sound_nocut:
    ...
    beq .famistudio_update_epsm_fm_channel_sound_write_hi_period
    .famistudio_update_epsm_fm_channel_sound_untrigger_prev_note:
        ; Untrigger note.  
        lda #FAMISTUDIO_EPSM_REG_KEY
        sta FAMISTUDIO_EPSM_REG_SEL0;
...
;        rts
    ...
    cmp #7
    bpl .famistudio_update_epsm_fm_channel_sound_op_1_2_3_4
    cmp #5
    bpl .famistudio_update_epsm_fm_channel_sound_op_2_3_4
    cmp #4
    bpl .famistudio_update_epsm_fm_channel_sound_op_2_4
    jmp .famistudio_update_epsm_fm_channel_sound_op_4
    
    ; todo
    .famistudio_update_epsm_fm_channel_sound_op_1_2_3_4:
        ...
        cmp #127
        bmi .famistudio_update_epsm_fm_channel_sound_save_op1
        lda #127
    .famistudio_update_epsm_fm_channel_sound_save_op1:
        ldx *.reg_offset
        sta FAMISTUDIO_EPSM_REG_WRITE0,x
    .famistudio_update_epsm_fm_channel_sound_op_2_3_4:
        ...
        adc famistudio_epsm_fm_vol_table,x
        cmp #127
        bmi .famistudio_update_epsm_fm_channel_sound_save_op3
        lda #127
    .famistudio_update_epsm_fm_channel_sound_save_op3:
        ldx *.reg_offset
        sta FAMISTUDIO_EPSM_REG_WRITE0,x
    .famistudio_update_epsm_fm_channel_sound_op_2_4:
        ...
        adc famistudio_epsm_fm_vol_table,x
        cmp #127
        bmi .famistudio_update_epsm_fm_channel_sound_save_op2
        lda #127
    .famistudio_update_epsm_fm_channel_sound_save_op2:
        ldx *.reg_offset
        sta FAMISTUDIO_EPSM_REG_WRITE0,x
    .famistudio_update_epsm_fm_channel_sound_op_4:
        ; Write volume
        ...
        adc famistudio_epsm_fm_vol_table,x
        cmp #127
        bmi .famistudio_update_epsm_fm_channel_sound_save_op4
        lda #127
    .famistudio_update_epsm_fm_channel_sound_save_op4:
        ldx *.reg_offset
        sta FAMISTUDIO_EPSM_REG_WRITE0,x
...
.pitch = famistudio_ptr1
    ...
    ;bne .famistudio_update_epsm_rhythm_channel_sound_note
...
famistudio_update_row:
    ...
    .endif
    .if FAMISTUDIO_EXP_EPSM
    .famistudio_update_epsm_rhythm_channel_sound_epsm_instrument:
...
famistudio_update_row_with_delays:
    ...
    bmi .famistudio_update_row_with_delays_done
    sec
    sbc #1
    sta famistudio_chn_cut_delay,x
    bpl .famistudio_update_row_with_delays_done ; When wrapping from 0 -> 0xff, we play the note.

    ; Write a stop note.
    lda #0
    sta famistudio_chn_note,x

    .famistudio_update_row_with_delays_done:
    rts
...
.update_vrc6_sound:
    ...
    .if FAMISTUDIO_EXP_MMC5
.update_mmc5_sound:
    famistudio_update_channel_sound FAMISTUDIO_MMC5_CH0_IDX, FAMISTUDIO_MMC5_CH0_ENVS, famistudio_mmc5_pulse1_prev, FAMISTUDIO_MMC5_PL1_HI, FAMISTUDIO_MMC5_PL1_LO, FAMISTUDIO_MMC5_PL1_VOL, , #0x20
    famistudio_update_channel_sound FAMISTUDIO_MMC5_CH1_IDX, FAMISTUDIO_MMC5_CH1_ENVS, famistudio_mmc5_pulse2_prev, FAMISTUDIO_MMC5_PL2_HI, FAMISTUDIO_MMC5_PL2_LO, FAMISTUDIO_MMC5_PL2_VOL, , #0x40
    .endif
...
.chan_idx   = famistudio_r1
    ...
    bcs .famistudio_set_epsm_instrument_not_square_channel
        ...
        sta famistudio_env_ptr+FAMISTUDIO_ENV_MIXER_IDX_OFF,x
        sta famistudio_env_value+FAMISTUDIO_ENV_MIXER_IDX_OFF,x
        bcc .famistudio_set_epsm_instrument_noisedone
        clc
        inx
        iny
        bcc .famistudio_set_epsm_instrument_loop

        .famistudio_set_epsm_instrument_noisedone:
    ...
    bmi .famistudio_set_epsm_instrument_fm_channel
        lda *.chan_idx
        ...
        ldx *.chan_idx    
        rts
    .famistudio_set_epsm_instrument_fm_channel:
    
    lda famistudio_chn_inst_changed-FAMISTUDIO_FIRST_EXP_INST_CHANNEL,x
    bne .famistudio_set_epsm_instrument_continue
        ldx *.chan_idx
        rts
    
.famistudio_set_epsm_instrument_continue:
    lda *.chan_idx
    ...
    bpl .famistudio_set_epsm_instrument_reg_set_1

    .famistudio_set_epsm_instrument_reg_set_0:
        famistudio_epsm_write_patch_reg FAMISTUDIO_EPSM_REG_SEL0, FAMISTUDIO_EPSM_REG_WRITE0
    jmp .famistudio_set_epsm_instrument_last_reg

    .famistudio_set_epsm_instrument_reg_set_1:
        famistudio_epsm_write_patch_reg FAMISTUDIO_EPSM_REG_SEL1, FAMISTUDIO_EPSM_REG_WRITE1
    
    .famistudio_set_epsm_instrument_last_reg:
        lda famistudio_epsm_register_order,x
        clc
        adc *.reg_offset
        sta FAMISTUDIO_EPSM_REG_SEL0
...
.set_vrc7_triggers:
    ...
    bcc .famistudio_update_channel_done
    lda #1
...
.famistudio_opcode_jmp_lo:
    ...
    .if FAMISTUDIO_USE_RELEASE_NOTES    
        .db <(.opcode_release_note)                 ; 0x44
    .else
        .db <(.opcode_invalid)                      ; 0x44
    .endif
    .if FAMISTUDIO_USE_FAMITRACKER_TEMPO    
        .db <(.opcode_famitracker_speed)            ; 0x45
    .else
        .db <(.opcode_invalid)                      ; 0x45
    .endif
    .if FAMISTUDIO_USE_FAMITRACKER_DELAYED_NOTES_OR_CUTS
        .db <(.opcode_note_delay)                   ; 0x46
        .db <(.opcode_cut_delay)                    ; 0x47
    .endif
    .ifeq FAMISTUDIO_USE_FAMITRACKER_TEMPO
        .db <(.opcode_set_tempo_envelope)           ; 0x46
        .db <(.opcode_reset_tempo_envelope)         ; 0x47
    .endif
    ...
    .endif
    .if FAMISTUDIO_USE_VIBRATO    
        .db <(.opcode_override_pitch_envelope)      ; 0x48
        .db <(.opcode_clear_pitch_override_flag)    ; 0x49
    .else
        .db <(.opcode_invalid)                      ; 0x48
        .db <(.opcode_invalid)                      ; 0x49
    .endif   
    .if FAMISTUDIO_USE_ARPEGGIO
        .db <(.opcode_override_arpeggio_envelope)   ; 0x4a
        .db <(.opcode_clear_arpeggio_override_flag) ; 0x4b
        .db <(.opcode_reset_arpeggio)               ; 0x4c
    .else
...
famistudio_note_table_msb:
    ...
    famistudio_epsm_s_note_table_lsb:
        .db 0x00
        .db 0xfa, 0x4b, 0xb5, 0x35, 0xcb, 0x75, 0x32, 0x02, 0xe2, 0xd3, 0xd2, 0xe1 ; Octave 0
        .db 0xfd, 0x25, 0x5a, 0x9a, 0xe5, 0x3a, 0x99, 0x00, 0x71, 0xe9, 0x69, 0xf0 ; Octave 1
        .db 0x7e, 0x12, 0xac, 0x4c, 0xf2, 0x9c, 0x4c, 0x00, 0xb8, 0x74, 0x34, 0xf7 ; Octave 2
        .db 0xbe, 0x89, 0x56, 0x26, 0xf8, 0xce, 0xa5, 0x7f, 0x5b, 0x39, 0x19, 0xfb ; Octave 3
        .db 0xdf, 0xc4, 0xaa, 0x92, 0x7c, 0x66, 0x52, 0x3f, 0x2d, 0x1c, 0x0c, 0xfd ; Octave 4
        .db 0xef, 0xe1, 0xd5, 0xc9, 0xbd, 0xb3, 0xa9, 0x9f, 0x96, 0x8e, 0x86, 0x7e ; Octave 5
        .db 0x77, 0x70, 0x6a, 0x64, 0x5e, 0x59, 0x54, 0x4f, 0x4b, 0x46, 0x42, 0x3f ; Octave 6
        .db 0x3b, 0x38, 0x34, 0x31, 0x2f, 0x2c, 0x29, 0x27, 0x25, 0x23, 0x21, 0x1f ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_epsm_s_note_table_msb:
        .db 0x00
        .db 0x1d, 0x1c, 0x1a, 0x19, 0x17, 0x16, 0x15, 0x14, 0x12, 0x11, 0x10, 0x0f ; Octave 0
        .db 0x0e, 0x0e, 0x0d, 0x0c, 0x0b, 0x0b, 0x0a, 0x0a, 0x09, 0x08, 0x08, 0x07 ; Octave 1
        .db 0x07, 0x07, 0x06, 0x06, 0x05, 0x05, 0x05, 0x05, 0x04, 0x04, 0x04, 0x03 ; Octave 2
...
famistudio_channel_to_volume_env:
    ...
    .db FAMISTUDIO_EPSM_CH9_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_EPSM_CH10_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_EPSM_CH11_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_EPSM_CH12_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_EPSM_CH13_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .db FAMISTUDIO_EPSM_CH14_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
...
famistudio_channel_to_arpeggio_env:
    ...
    .db FAMISTUDIO_EPSM_CH9_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_EPSM_CH10_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_EPSM_CH11_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_EPSM_CH12_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_EPSM_CH13_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .db FAMISTUDIO_EPSM_CH14_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .endif
...
; This table will only be defined if we use noise slides, otherwise identical to "famistudio_channel_to_pitch_env".
    ...
    .db FAMISTUDIO_EPSM_CH9_PITCH_ENV_IDX
    .db FAMISTUDIO_EPSM_CH10_PITCH_ENV_IDX
    .db FAMISTUDIO_EPSM_CH11_PITCH_ENV_IDX
    .db FAMISTUDIO_EPSM_CH12_PITCH_ENV_IDX
    .db FAMISTUDIO_EPSM_CH13_PITCH_ENV_IDX
    .db FAMISTUDIO_EPSM_CH14_PITCH_ENV_IDX
    .endif
    .endif
